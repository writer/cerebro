...
// domain response. User preferences add only route wiring; HTTP behavior lives
// in internal/sourcehttp/userpreferences and storage stays behind the
// UserPreferenceStore port.
const bootstrapProductionGoLineBudget = 26053
