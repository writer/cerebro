...
func TestEmbeddedWasmGuestMemoryProtocol(t *testing.T) {
	...
	protocols := []wasmGuestProtocol{
		...
		},
		{
			...
			validInput: `{"schema_version":"cerebro.finding-rule-authority.v1","input_digest":"sha256:138175849564dc77fcd4c62497ea4789f07f1009c31da16a1a57bd8c69ec8c38","request":{"operation":"open_anchor","rule_id":"tailscale-tailnet-device-approval-disabled","runtime_id":"","runtime_source_id":"","runtime_tenant_id":"","runtime_workspace_id":"","event_id":"","event_tenant_id":"","event_source_id":"","event_kind":"","event_schema_ref":"","occurred_at":"","replay_sequence":0,"attributes":{},"payload":[]}}`,
		},
		{
