...
invariants documented in `docs/engineering/non-goals.md` and this directory.
...
5. Update `docs/engineering/non-goals.md` if the rule enforces or changes a documented boundary.
