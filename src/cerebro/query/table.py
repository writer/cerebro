...
class SecurityTable(ABC):
    ...
    def __init__(self, name: str, description: str, columns: Optional[List[SecurityColumn]] = None):
        self.name = name
    ...
    @abstractmethod
    async def list_resources(self, ctx: QueryContext) -> AsyncGenerator[Dict[str, Any], None]:
        """
    ...
    def apply_filters(self, resource: Dict[str, Any], filters: List[QueryFilter]) -> bool:
        """
    ...
    def _apply_single_filter(self, resource: Dict[str, Any], filter_condition: QueryFilter) -> bool:
...
class ProviderSecurityTable(SecurityTable):
    ...
    def __init__(self, name: str, description: str, provider_name: str, 
