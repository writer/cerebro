...
class ReportTemplate:
    ...
    target_audience: List[str] = field(default_factory=list)  # executives, auditors, managers
...
class ComplianceAnalytics:
    ...
    def generate_executive_dashboard(
        ...
        control_effectiveness = self._analyze_control_effectiveness(start_date, end_date)
        ...
        return {
            ...
            "executive_summary": {
                ...
                "automated_controls_percentage": compliance_overview["automation_percentage"],
                "high_risk_count": len(risk_dashboard["risk_summary"]["high_risks"]),
                "overdue_items_count": len(risk_dashboard["treatment_summary"]["overdue_treatments"]),
                "evidence_freshness_score": evidence_freshness["average_freshness_score"]
            },
    ...
    def generate_audit_readiness_report(
        ...
        return {
            ...
            "auditor_package_status": {
                ...
                "pending_reviews": len([g for g in gaps if g["type"] == "pending_review"]),
                "estimated_package_completeness": readiness_score["package_completeness"]
            }
        }
    ...
    def create_board_presentation(
        ...
        slides.append({
            ...
            "key_metrics": {
                ...
                "High-Risk Items": dashboard_data['executive_summary']['high_risk_count'],
                "Evidence Freshness": f"{dashboard_data['executive_summary']['evidence_freshness_score']:.1f}%"
            },
            "status_indicator": "green" if dashboard_data['executive_summary']['overall_compliance_score'] >= 85 else "yellow",
            "visualization": self._create_compliance_scorecard_visual(dashboard_data)
        })
        ...
        slides.append({
            ...
            "automation_progress": dashboard_data['compliance_overview']['automation_percentage'],
        ...
        presentation = {
            ...
            "executive_summary": {
                "key_accomplishments": self._identify_key_accomplishments(dashboard_data),
                "areas_of_concern": self._identify_areas_of_concern(dashboard_data, risk_data),
                "strategic_recommendations": self._generate_strategic_recommendations(dashboard_data)
            }
        }
    ...
    def calculate_compliance_kpis(self) -> Dict[str, Any]:
        ...
        for kpi_id, kpi in self._kpis.items():
            try:
                ...
                status = "green"
                if kpi.red_threshold and self._exceeds_threshold(value, kpi.red_threshold, kpi.trend_direction):
                    status = "red"
                elif kpi.yellow_threshold and self._exceeds_threshold(value, kpi.yellow_threshold, kpi.trend_direction):
                    status = "yellow"
    ...
    def _calculate_compliance_overview(self, frameworks: List[str] = None) -> Dict[str, Any]:
        ...
        overall_score = (passing_controls / total_controls * 100) if total_controls > 0 else 0
    ...
    def _analyze_control_effectiveness(self, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
    ...
    def _analyze_evidence_freshness(self, start_date: datetime, end_date: datetime) -> Dict[str, Any]:
        ...
        for record in evidence_records:
            ...
            if age_hours <= 24:
                ...
                score = max(0, 100 - ((age_hours - 24) / 144 * 80))  # 80% penalty over 6 days
            else:
                score = 0
        ...
        return {
            ...
            "freshness_by_source": self._calculate_freshness_by_source(evidence_records)
        }
    ...
    def _calculate_compliance_trends(self, time_period_days: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "historical_scores": [
                {"date": (datetime.now() - timedelta(days=90)).isoformat(), "score": 82.1},
                {"date": (datetime.now() - timedelta(days=60)).isoformat(), "score": 84.3},
                {"date": (datetime.now() - timedelta(days=30)).isoformat(), "score": 86.7},
                {"date": datetime.now().isoformat(), "score": 87.2}
            ]
        }
    
    def _identify_key_actions(self, compliance_data, risk_data, control_data) -> List[Dict[str, Any]]:
    ...
    def _exceeds_threshold(self, value: float, threshold: float, direction: str) -> bool:
    ...
    def _create_compliance_scorecard_visual(self, dashboard_data: Dict[str, Any]) -> str:
        ...
        wedges, texts = ax.pie([60, 15, 10, 15], labels=categories, colors=colors, 
