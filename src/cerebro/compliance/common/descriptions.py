...
FRAMEWORK_NAME_DESCRIPTION = (
    "Framework name for compliance operations, e.g. 'SOC 2 Type II', 'ISO 27001', or 'PCI DSS'"
)
...
CONTROL_CATEGORY_DESCRIPTION = (
    "Control category filter, e.g. 'Access Controls', 'System Monitoring', or 'Configuration Management'"
)
...
TENANT_ID_DESCRIPTION = (
    "Tenant ID to operate on for multi-tenant operations"
)

# Evidence and Assessment Descriptions
EVIDENCE_TYPE_DESCRIPTION = (
    "Evidence type filter, e.g. 'configuration', 'access_log', 'audit_log', or 'system_report'"
)

ASSESSMENT_PERIOD_DESCRIPTION = (
    "Assessment period for evidence collection in ISO format, e.g. '2024-01-01' to '2024-12-31'"
)

PERIOD_START_DESCRIPTION = (
    "Start date for evidence collection period in ISO format, e.g. '2024-01-01T00:00:00Z'"
)
...
COMPLIANCE_STATUS_DESCRIPTION = (
    "Filter by compliance status, e.g. 'compliant', 'non-compliant', 'partial', or 'unknown'"
)
...
ANALYSIS_TYPE_DESCRIPTION = (
    "Type of analysis to perform, e.g. 'gap_analysis', 'trend_analysis', or 'risk_assessment'"
)
...
INCLUDE_EVIDENCE_DESCRIPTION = (
    "Whether to include detailed evidence in the report response. Default is false for performance."
)
