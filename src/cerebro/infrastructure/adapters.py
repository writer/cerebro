    ...
    async def save_iam_permissions(
        ...
        for perm in permissions:
            ...
            iam_data.append({
                ...
                "provider": permissions[0].principal_external_id.split(".")[0],  # Extract from external_id
    ...
    async def get_findings_by_status(
        ...
        for db_finding in db_findings:
            finding = FindingEntity(
                ...
                resource_external_id=str(db_finding.resource_id) if db_finding.resource_id else None,
                principal_external_id=str(db_finding.principal_id) if db_finding.principal_id else None,
    ...
    async def evaluate_rule(
        ...
        if iam_permission:
            eval_context.iam_edge = {
                ...
                "effective_at": iam_permission.effective_at.isoformat() if iam_permission.effective_at else None,
            }
