                ...
                try:
                    ...
                    for attr_name in dir(module):
                        ...
                        if (isinstance(attr, type) and 
                            ...
                            callable(getattr(attr, 'authenticate', None))):
                            ...
                            try:
                                ...
                                logger.debug(f"Could not auto-register {attr_name}: {e}")
...
def create_aws_provider(account_id: str, aws_account_id: str, region: str = None, **kwargs):
...
def init_providers():
    ...
    logger.info(f"Provider registry initialized with: {provider_registry.list_providers()}")
