...
def generate_attack_path_scenario() -> Dict[str, Any]:
    ...
    findings = [
        {
            ...
            "evidence": {
                ...
                "lateral_movement": {
                    "stepping_stones": ["Web server", "Build server", "Database access"],
        ...
        },
        {
            ...
            "evidence": {
                "exfiltration_potential": {
                    ...
                    "data_types": ["Customer databases", "Application source code", "Configuration data", "Security policies"],
                    "exfiltration_methods": ["Direct S3 download", "Cross-region replication", "External sharing"]
                },
                "detection_evasion": {
                    "legitimate_service_account": True,
                    "normal_backup_patterns": "Could mask exfiltration",
                    "monitoring_gaps": ["No data volume alerts", "No unusual access pattern detection"]
                },
                "business_impact": {
    ...
    return {
        ...
        "attack_analysis": {
            "attack_chains": [
                {
                    ...
                    "steps": [
                        {"step": 1, "action": "Initial access", "asset": "Developer workstation", "method": "Credential compromise"},
                        {"step": 2, "action": "Privilege escalation", "asset": "Web server", "method": "SSH access + vulnerabilities"},
                        {"step": 3, "action": "Lateral movement", "asset": "Build server", "method": "Cross-account role assumption"}, 
                        {"step": 4, "action": "Privilege escalation", "asset": "Build service account", "method": "Service account impersonation"},
                        {"step": 5, "action": "Data access", "asset": "Core database", "method": "Database connection"},
                        {"step": 6, "action": "Data exfiltration", "asset": "Backup system", "method": "S3 download"}
                    ],
                    "likelihood": "High",
                    "impact": "Critical",
                    "risk_score": 95
            ...
            "critical_nodes": [
                {"asset": "Build service account", "criticality": "Single point of failure"},
                {"asset": "Cross-account role", "criticality": "Privilege escalation enabler"},
        ...
        "investigation_notes": {
            ...
            "stakeholders": ["CISO", "Incident Response Team", "Network Security", "Application Security"]
        },
        "agent_prompts": [
...
def print_attack_path_summary(scenario: Dict[str, Any]):
    ...
    print(f"Estimated Breach Cost: {scenario['investigation_notes']['estimated_breach_cost']}")
    print(f"Remediation Urgency: {scenario['investigation_notes']['remediation_urgency']}")
