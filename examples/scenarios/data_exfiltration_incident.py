    ...
    audit_events.extend([
        {
            ...
            "raw": {
                ...
                "additionalEventData": {"LoginTo": "https://console.aws.amazon.com"},
                "suspicious_indicators": ["tor_ip", "unusual_location", "off_hours"]
            }
        },
        {
            "event_id": uuid4(),
            ...
            "raw": {
                ...
                "responseElements": {"user": {"userName": "backup-service-user", "path": "/"}},
                "requestParameters": {"userName": "backup-service-user"},
                "suspicious_indicators": ["shadow_account_creation", "privilege_escalation"]
            }
        }
    ])
    ...
    for day_offset in range(-25, -7):
        ...
        audit_events.append({
            ...
            "raw": {
                ...
                "responseElements": {"buckets": ["financeflow-financial-reports", "customer-data-backup"]},
                "suspicious_indicators": ["data_discovery", "systematic_enumeration"]
            }
        })
    ...
    for hour in range(0, 48):  # 48 hours of intensive downloading
        ...
        large_download_events.append({
            ...
            "raw": {
                ...
                "responseElements": {"bytesTransferred": random.randint(50000000, 500000000)},  # 50MB - 500MB
                "requestParameters": {"bucketName": "financeflow-financial-reports"},
                "suspicious_indicators": ["bulk_download", "sensitive_data_access", "off_hours"]
            }
        })
    ...
    findings = [
        ...
        },
        {
            ...
            "evidence": {
                ...
                "new_table_access": ["customer_financial_profiles", "account_balances", "transaction_history"],
...
def print_incident_timeline(scenario: Dict[str, Any]):
    ...
    print(f"  Day -30: Initial compromise via Tor ({events[0]['raw']['sourceIPAddress']})")
    ...
    for finding in scenario['findings']:
        ...
        if 'affected_customers' in finding['evidence']:
            impact = f" (affects {finding['evidence']['affected_customers']:,} customers)"
