...
jetstream_stream_bytes_alarm_threshold = _config_int("jetstreamStreamBytesAlarmThreshold", 0)
jetstream_app_error_alarm_threshold = _config_int("jetstreamAppErrorAlarmThreshold", 10)
jetstream_publish_retry_alarm_threshold = _config_int("jetstreamPublishRetryAlarmThreshold", 25)
...
monitoring_stack = monitoring.create_monitoring(
    ...
    jetstream_stream_bytes_alarm_threshold=jetstream_stream_bytes_alarm_threshold,
    jetstream_app_error_alarm_threshold=jetstream_app_error_alarm_threshold,
    jetstream_publish_retry_alarm_threshold=jetstream_publish_retry_alarm_threshold,
    nats_log_group_name=nats_stack["log_group"].name,
