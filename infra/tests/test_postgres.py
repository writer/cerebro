...
class PostgresTest(unittest.TestCase):
    def test_default_max_allocated_storage_keeps_existing_formula(self) -> None:
        self.assertEqual(postgres._default_max_allocated_storage(20), 40)
        self.assertEqual(postgres._default_max_allocated_storage(100), 200)
        self.assertEqual(postgres._default_max_allocated_storage(5), 25)
