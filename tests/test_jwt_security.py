...
class TestJWTKeyStore:
    ...
    async def test_key_rotation_logic(self, test_db):
        ...
        with patch('cerebro.core.security.key_store.get_kms', return_value=mock_kms):
            ...
            # Simulate expired key by modifying created_at
            key1.created_at = datetime.utcnow() - timedelta(hours=25)  # Older than rotation period
...
class TestBackgroundTasks:
    ...
    async def test_key_rotation_task_logic(self, test_db):
        ...
        with patch('cerebro.core.security.key_store.get_kms', return_value=mock_kms), \
             patch('cerebro.tasks.jwt_rotation.async_session_factory') as mock_session_factory:
    ...
    def test_periodic_task_configuration(self):
        ...
        assert mock_sender.add_periodic_task.call_count >= 3  # rotation, cleanup, health
...
class TestMetricsIntegration:
    ...
    def test_auth_metrics_recording(self):
        ...
        auth_metrics.record_authorization_check("/api/v1/findings", "read:findings", True)
