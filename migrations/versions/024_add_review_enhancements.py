...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_agent_review_tasks_assigned_to", "agent_review_tasks", ["assigned_to"]
    )
    ...
    op.create_index(
        "ix_agent_review_comments_task_id", "agent_review_comments", ["task_id"]
    )
    op.create_index(
        "ix_agent_review_comments_created_at", "agent_review_comments", ["created_at"]
    )
    ...
    op.create_index(
        "ix_agent_review_history_task_id", "agent_review_history", ["task_id"]
    )
    op.create_index(
        "ix_agent_review_history_change_type", "agent_review_history", ["change_type"]
    )
    op.create_index(
        "ix_agent_review_history_created_at", "agent_review_history", ["created_at"]
    )
