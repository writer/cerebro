...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name", sa.String(255), nullable=False, comment="Human-readable name"
        ),
        ...
        sa.Column(
            "smtp_password", sa.Text(), nullable=True, comment="Encrypted password"
        ),
        ...
        sa.Column(
            ...
            nullable=False,
            comment="List of recipient emails",
        ),
        ...
        sa.Column(
            ...
            default=False,
            nullable=False,
            comment="Send digest instead of immediate",
        ),
        sa.Column(
            "digest_frequency", sa.String(50), nullable=True, comment="daily, weekly"
        ),
        sa.Column(
            "email_metadata",
            postgresql.JSONB(),
    ...
    op.create_table(
        ...
        sa.Column(
            "config_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("email_configs.config_id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "org_id",
    ...
    op.create_index(
        "ix_email_notifications_config_id", "email_notifications", ["config_id"]
    )
    ...
    op.create_index(
        "ix_email_notifications_created_at", "email_notifications", ["created_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            default="POST",
            comment="POST, PUT, PATCH",
        ),
        sa.Column(
            "headers", postgresql.JSONB(), nullable=True, comment="Custom headers"
        ),
        sa.Column(
            "payload_template",
            postgresql.JSONB(),
            nullable=False,
            comment="Jinja2 template",
        ),
        sa.Column(
            "authentication", postgresql.JSONB(), nullable=True, comment="Auth config"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "config_id",
            postgresql.UUID(as_uuid=True),
            sa.ForeignKey("webhook_configs.config_id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column(
            "org_id",
    ...
    op.create_index(
        "ix_webhook_notifications_config_id", "webhook_notifications", ["config_id"]
    )
    op.create_index(
        "ix_webhook_notifications_org_id", "webhook_notifications", ["org_id"]
    )
    op.create_index(
        "ix_webhook_notifications_status", "webhook_notifications", ["status"]
    )
    op.create_index(
        "ix_webhook_notifications_created_at", "webhook_notifications", ["created_at"]
    )
