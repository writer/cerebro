...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_security_metric_snapshots_org_id", "security_metric_snapshots", ["org_id"]
    )
    op.create_index(
        "ix_security_metric_snapshots_metric_type",
        "security_metric_snapshots",
        ["metric_type"],
    )
    op.create_index(
        "ix_security_metric_snapshots_captured_at",
        "security_metric_snapshots",
        ["captured_at"],
    )
    op.create_index(
        "ix_security_metric_snapshots_aggregation_period",
        "security_metric_snapshots",
        ["aggregation_period"],
    )
    ...
    op.create_index(
        "ix_security_metric_snapshots_org_metric_time",
        "security_metric_snapshots",
