...
def upgrade() -> None:
    ...
    op.create_table('security_reviews',
        sa.Column('review_id', postgresql.UUID(as_uuid=True), nullable=False, default=sa.text('gen_random_uuid()')),
        ...
        sa.Column('requested_at', sa.DateTime(timezone=True), nullable=False, default=sa.text('now()')),
    ...
    op.create_table('security_review_controls',
        sa.Column('control_id', postgresql.UUID(as_uuid=True), nullable=False, default=sa.text('gen_random_uuid()')),
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, default=sa.text('now()')),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, default=sa.text('now()')),
        sa.ForeignKeyConstraint(['review_id'], ['security_reviews.review_id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('control_id')
    )
    
    # Vendor Risk Assessments table
    op.create_table('vendor_risk_assessments',
        sa.Column('assessment_id', postgresql.UUID(as_uuid=True), nullable=False, default=sa.text('gen_random_uuid()')),
        sa.Column('vendor_id', sa.String(100), nullable=False),
        sa.Column('org_id', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('assessment_type', sa.String(50), nullable=False),
        sa.Column('assessment_date', sa.DateTime(timezone=True), nullable=False, default=sa.text('now()')),
        ...
        sa.Column('assessment_frequency_days', sa.Integer(), nullable=False, default=365),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False, default=sa.text('now()')),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False, default=sa.text('now()')),
        sa.Column('is_active', sa.Boolean(), nullable=False, default=True),
        sa.ForeignKeyConstraint(['org_id'], ['orgs.org_id'], ondelete='CASCADE'),
    ...
    op.create_table('test_entities',
        sa.Column('entity_id', postgresql.UUID(as_uuid=True), nullable=False, default=sa.text('gen_random_uuid()')),
        sa.Column('org_id', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table('test_executions',
        sa.Column('execution_id', postgresql.UUID(as_uuid=True), nullable=False, default=sa.text('gen_random_uuid()')),
        ...
        sa.Column('environment', sa.String(50), nullable=False),
        sa.Column('scheduled_at', sa.DateTime(timezone=True), nullable=False, default=sa.text('now()')),
        sa.Column('started_at', sa.DateTime(timezone=True), nullable=True),
        sa.Column('completed_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index('ix_security_review_controls_review_id', 'security_review_controls', ['review_id'])
    op.create_index('ix_security_review_controls_status', 'security_review_controls', ['assessment_status'])
    
    op.create_index('ix_vendor_risk_assessments_vendor_id', 'vendor_risk_assessments', ['vendor_id'])
    op.create_index('ix_vendor_risk_assessments_org_id', 'vendor_risk_assessments', ['org_id'])
    op.create_index('ix_vendor_risk_assessments_risk_level', 'vendor_risk_assessments', ['risk_level'])
    ...
    op.create_index('ix_test_executions_status', 'test_executions', ['execution_status'])
    op.create_index('ix_test_executions_scheduled_at', 'test_executions', ['scheduled_at'])
