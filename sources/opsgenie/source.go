...
const (
	...
	defaultBaseURLTemplate = "https://api.opsgenie.com"
	tokenHeader            = ""
	tokenScheme            = "Token"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "opsgenie"},
			},
			{
				Name:             familyTickets,
				Path:             "/v1/tickets",
				URNKind:          "opsgenie_tickets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "tickets", "source_system": "opsgenie"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "opsgenie_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "opsgenie"},
			},
		},
	})
	if err != nil {
