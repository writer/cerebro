...
const (
	sourceID               = "cockroachdb_cloud"
	defaultFamily          = familyAssets
	defaultHealthPath      = "/api/v1/user"
	defaultBaseURLTemplate = "https://cockroachlabs.cloud/api"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyAssets           = "assets"
		...
		Families: []jsonapi.Family{
			{
				Name:             familyAssets,
				Path:             "/v1/assets",
				URNKind:          "cockroachdb_cloud_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "cockroachdb_cloud"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "cockroachdb_cloud_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "cockroachdb_cloud"},
			},
			{
				Name:             familyVulnerabilities,
				Path:             "/v1/vulnerabilities",
				URNKind:          "cockroachdb_cloud_vulnerabilities",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "vulnerabilities", "source_system": "cockroachdb_cloud"},
			},
		},
	})
	if err != nil {
