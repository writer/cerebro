...
// NewFixture constructs the deterministic avaza source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"bill", "billpayment", "company", "contact", "creditnote", "currency", "estimate", "expense", "lookup", "projectmember", "userprofile", "webhook"} {
