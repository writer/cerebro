	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				IDKeys:           []string{"CurrencyCode", "Name"},
				ListKeys:         []string{"Currencies"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"id": "CurrencyCode", "name": "Name", "provider_id": "CurrencyCode", "resource_id": "CurrencyCode", "resource_name": "Name", "source_event_id": "CurrencyCode"},
				StaticAttributes: map[string]string{"record_class": "asset", "resource_type": "currency", "schema": "currency", "source_system": "avaza"},
				Config: jsonapi.FamilyConfig{
					AuthModel:        "none",
					ConfigAttributes: map[string]string{"tenant_id": "tenant_id"},
					EncodeURNID:      true,
					ResourceURNKind:  "avaza_currency",
				},
			},
			{
				Name:             familyEstimate,
