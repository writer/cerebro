...
const (
	sourceID               = "biapi"
	defaultFamily          = familyLogo
	defaultHealthPath      = "/banks/${config.id_connector}/logos"
	defaultBaseURLTemplate = "//budgea.biapi.pro/2.0"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyLogo             = "logo"
	familyAccount          = "account"
	familyAddToData        = "add_to_data"
	familyAlert            = "alert"
)

var templateKeys = []string{"id_connection", "id_connector", "id_user", "id_webhook", "token"}
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			{
				Name:             familyLogo,
				Path:             "/banks/${config.id_connector}/logos",
				URNKind:          "biapi_logo",
				IDKeys:           []string{"id", "event_id", "uuid", "request_id"},
				ListKeys:         []string{"connectorlogos"},
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "logo", "source_system": "biapi"},
			},
			{
				Name:             familyAccount,
				Path:             "/users/${config.id_user}/connections/${config.id_connection}/accounts",
				URNKind:          "biapi_account",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "account", "source_system": "biapi"},
			},
			{
				Name:             familyAddToData,
				Path:             "/webhooks/${config.id_webhook}/add_to_data",
				URNKind:          "biapi_add_to_data",
				IDKeys:           []string{"id", "url", "urn", "resource_urn", "name"},
				ListKeys:         []string{"webhooks"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "name": "url", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "id", "resource_name": "url", "resource_type": "add_to_data", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "add_to_data", "source_system": "biapi"},
			},
			{
				Name:             familyAlert,
				Path:             "/users/${config.id_user}/alerts",
				URNKind:          "biapi_alert",
				IDKeys:           []string{"id", "alert_id", "sid", "incident_id", "uuid"},
				ListKeys:         []string{"alerts"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"alert_description": "description|summary|message|body", "alert_fired_at": "fired_at|triggered_at|created_at|occurred_at|timestamp", "alert_id": "id", "alert_name": "id", "alert_resolved_at": "resolved_at|closed_at|acknowledged_at", "alert_severity": "id", "alert_source": "source|alert_source|monitor|check", "alert_status": "id", "alert_type": "alert_type|type|category|kind", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "name": "id", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "alert", "schema": "alert", "source_system": "biapi"},
			},
		},
	})
	if err != nil {
