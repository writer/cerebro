...
const (
	sourceID               = "azure_devops"
	defaultFamily          = familyRepositories
	defaultHealthPath      = "/_apis/projects"
	defaultBaseURLTemplate = "https://dev.azure.com/${config.organization}"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
...
var templateKeys = []string{"client_id", "client_secret", "organization"}
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://dev.azure.com/${config.organization}/oauth/token",
		Families: []jsonapi.Family{
			{
				Name:             familyRepositories,
				Path:             "/v1/repositories",
				URNKind:          "azure_devops_repositories",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "azure_devops"},
			},
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "azure_devops_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "azure_devops"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "azure_devops_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "azure_devops"},
			},
		},
	})
	if err != nil {
