...
const (
	...
	defaultHealthPath      = "/gateway/ng/api/user/currentUser"
	defaultBaseURLTemplate = "https://app.harness.io"
	tokenHeader            = ""
	tokenScheme            = "Token"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "pipelines", "source_system": "harness"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/findings",
				URNKind:          "harness_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "harness"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "harness_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "harness"},
			},
		},
	})
	if err != nil {
