...
// NewFixture constructs the deterministic rebilly source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"aml", "authentication_token", "bank_account", "customer_timeline_custom_event"} {
