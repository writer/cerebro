...
// NewFixture constructs the deterministic google_gemini source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"batch_jobs", "cached_contents", "files", "model_catalog", "tuned_models"} {
