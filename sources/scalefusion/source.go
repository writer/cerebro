		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "scalefusion"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "scalefusion_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "scalefusion"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "scalefusion_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "scalefusion"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "scalefusion_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "scalefusion"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "scalefusion_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "scalefusion"},
			},
		},
	})
	if err != nil {
