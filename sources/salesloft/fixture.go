...
// NewFixture constructs the deterministic salesloft source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"account_stages_json", "cadence_memberships_json", "crm_activity_fields_json", "groups_json"} {
