...
const (
	sourceID                     = "salesloft"
	defaultFamily                = familyCrmActivityFieldsJson
	defaultHealthPath            = "/v2/crm_activity_fields.json"
	defaultBaseURLTemplate       = "https://api.salesloft.com"
	tokenHeader                  = ""
	tokenScheme                  = "Bearer"
	oauthTokenURLTemplate        = "https://accounts.salesloft.com/oauth/token" // #nosec G101 -- token endpoint URL template, not credential material.
	oauthScopeSeparator          = " "
	oauthTokenExpirationBuffer   = 300 * time.Second
	familyCrmActivityFieldsJson  = "crm_activity_fields_json"
	familyAccountStagesJson      = "account_stages_json"
	familyCadenceMembershipsJson = "cadence_memberships_json"
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:               "https://accounts.salesloft.com/oauth/token",
		OAuthTokenRequestAuthMethod: "client_secret_basic",
		Families: []jsonapi.Family{
			{
				Name:             familyCrmActivityFieldsJson,
				Path:             "/v2/crm_activity_fields.json",
				URNKind:          "salesloft_crm_activity_fields_json",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "crm_activity_fields_json", "source_system": "salesloft"},
			},
			{
				Name:             familyAccountStagesJson,
				Path:             "/v2/account_stages.json",
				URNKind:          "salesloft_account_stages_json",
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups_json", "source_system": "salesloft"},
			},
		},
	})
	if err != nil {
