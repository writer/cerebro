...
const (
	sourceID               = "brex"
	defaultFamily          = familyCards
	defaultHealthPath      = "/v2/users"
	defaultBaseURLTemplate = "https://api.brex.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyCards            = "cards"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "cards", "source_system": "brex"},
			},
			{
				Name:             familyUsers,
				Path:             "/v2/users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "brex"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "brex_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "brex"},
			},
		},
	})
	if err != nil {
