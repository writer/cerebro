...
// NewFixture constructs the deterministic mailscript source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"action", "addresses", "domain", "input", "integration", "key", "trigger", "verification", "verify", "workflow", "workspace"} {
