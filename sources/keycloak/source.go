...
const (
	...
	defaultBaseURLTemplate = "https://${config.realm_url}"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
	familyGroups           = "groups"
...
var templateKeys = []string{"token", "realm_url"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "keycloak"},
			},
			{
				Name:             familyGroups,
				Path:             "/groups",
				URNKind:          "keycloak_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "keycloak"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/events",
				URNKind:          "keycloak_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "keycloak"},
			},
		},
	})
	if err != nil {
