		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "dynamics_365_sales_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "dynamics_365_sales"},
			},
			{
				Name:             familyAccounts,
				Path:             "/v1/accounts",
				URNKind:          "dynamics_365_sales_accounts",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "accounts", "source_system": "dynamics_365_sales"},
			},
			{
				Name:             familyRecords,
				Path:             "/v1/records",
				URNKind:          "dynamics_365_sales_records",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "records", "source_system": "dynamics_365_sales"},
			},
			{
				Name:             familyPolicies,
				Path:             "/v1/policies",
				URNKind:          "dynamics_365_sales_policies",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "policies", "source_system": "dynamics_365_sales"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "dynamics_365_sales_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "dynamics_365_sales"},
			},
		},
	})
	if err != nil {
