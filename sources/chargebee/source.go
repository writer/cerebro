...
const (
	sourceID               = "chargebee"
	defaultFamily          = familySubscriptions
	defaultHealthPath      = "/customers"
	defaultBaseURLTemplate = "https://${config.site}.chargebee.com/api/v2"
	tokenHeader            = ""
	tokenScheme            = "Basic"
	familySubscriptions    = "subscriptions"
	familyCustomers        = "customers"
	familyAuditEvents      = "audit_events"
)

var templateKeys = []string{"password", "username", "site"}
		...
		Families: []jsonapi.Family{
			{
				...
				Path:             "/subscriptions",
				URNKind:          "chargebee_subscriptions",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "subscriptions", "source_system": "chargebee"},
			},
			{
				Name:             familyCustomers,
				Path:             "/customers",
				URNKind:          "chargebee_customers",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "customers", "source_system": "chargebee"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/events",
				URNKind:          "chargebee_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "chargebee"},
			},
		},
	})
	if err != nil {
