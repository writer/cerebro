...
func TestSourceCheckAndRead(t *testing.T) {
	...
	defer server.Close()
	cfgValues := map[string]string{"tenant_id": "tenant", "base_url": server.URL, "family": defaultFamily, "token": "test-token", "site": "test-site"}
	...
	event := pull.Events[0]
	if event.Kind != "chargebee.subscriptions" {
