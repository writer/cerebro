		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "lumos_identity"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "lumos_identity_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "lumos_identity"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "lumos_identity_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "lumos_identity"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "lumos_identity_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "lumos_identity"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "lumos_identity_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "lumos_identity"},
			},
		},
	})
	if err != nil {
