		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "pathlock"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "pathlock_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "pathlock"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "pathlock_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "pathlock"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "pathlock_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "pathlock"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "pathlock_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "pathlock"},
			},
		},
	})
	if err != nil {
