...
const (
	sourceID               = "cortex_xsoar"
	defaultFamily          = familyAuditEvents
	defaultHealthPath      = "/xsoar/public/v1/health"
...
var templateKeys = []string{"api_key", "instance_url"}
		...
		Families: []jsonapi.Family{
			{
				...
				Path:             "/v1/events",
				URNKind:          "cortex_xsoar_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "cortex_xsoar"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/cases",
				URNKind:          "cortex_xsoar_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "cortex_xsoar"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/assets",
				URNKind:          "cortex_xsoar_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "cortex_xsoar"},
			},
		},
	})
	if err != nil {
