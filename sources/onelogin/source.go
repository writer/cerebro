...
const (
	...
	defaultHealthPath          = "/api/1/users"
	defaultBaseURLTemplate     = "https://api.us.onelogin.com"
	tokenHeader                = ""
	tokenScheme                = "Bearer"
	oauthTokenURLTemplate      = "https://api.us.onelogin.com/oauth/token" // #nosec G101 -- token endpoint URL template, not credential material.
	oauthScopeSeparator        = " "
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://api.us.onelogin.com/oauth/token",
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "onelogin"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "onelogin"},
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "onelogin"},
			},
		},
	})
	if err != nil {
