		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "cyolo"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "cyolo_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "cyolo"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "cyolo"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "cyolo_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "cyolo"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "cyolo_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "cyolo"},
			},
		},
	})
	if err != nil {
