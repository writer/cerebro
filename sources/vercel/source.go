...
const (
	...
	defaultBaseURLTemplate = "https://api.vercel.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "vercel"},
			},
			{
				Name:             familyDeployments,
				Path:             "/v6/deployments",
				URNKind:          "vercel_deployments",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "deployments", "source_system": "vercel"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "vercel_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "vercel"},
			},
		},
	})
	if err != nil {
