...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthScopes:                 []string{"attachments:delete", "attachments:read", "attachments:write", "custom_fields:read", "custom_fields:write", "default", "email", "goals:read", "jobs:read", "ooo_entries:delete", "ooo_entries:read", "ooo_entries:write", "openid", "portfolios:read", "portfolios:write", "profile", "project_portfolio_settings:read", "project_portfolio_settings:write", "project_templates:read", "projects:delete", "projects:read", "projects:write", "roles:delete", "roles:read", "roles:write", "stories:read", "stories:write", "tags:read", "tags:write", "task_custom_types:read", "task_templates:read", "tasks:delete", "tasks:read", "tasks:write", "team_memberships:read", "teams:read", "time_tracking_categories:delete", "time_tracking_categories:read", "time_tracking_categories:write", "time_tracking_entries:read", "timesheet_approval_statuses:read", "timesheet_approval_statuses:write", "users:read", "webhooks:delete", "webhooks:read", "webhooks:write", "workspaces:read"},
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "role", "source_system": "asana"},
			},
			{
				Name:             familyUser,
				Path:             "/users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "user", "source_system": "asana"},
			},
		},
	})
	if err != nil {
