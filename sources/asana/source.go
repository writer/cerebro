		...
		Families: []jsonapi.Family{
			{
				...
				Config:           jsonapi.FamilyConfig{ConfigQuery: map[string]string{"workspace": "workspace_gid"}, ConfigAttributes: map[string]string{"workspace_gid": "workspace_gid"}, ResourceURNKind: "runtime_users"},
			},
			{
				Name:             familyProjects,
				Path:             "/projects",
