...
const (
	sourceID               = "exavault"
	defaultFamily          = familyEmailList
	defaultHealthPath      = "/email-lists"
	defaultBaseURLTemplate = "https://accountname.exavault.com/api/v2"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyEmailList        = "email_list"
	familyNotification     = "notification"
	familySession          = "session"
	familySshKey           = "ssh_key"
)
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "session", "source_system": "exavault"},
			},
			{
				Name:             familySshKey,
				Path:             "/ssh-keys",
				URNKind:          "exavault_ssh_key",
				IDKeys:           []string{"id", "attributes", "urn", "resource_urn", "name"},
				PageSizeParams:   []string{"limit"},
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "name": "attributes", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "id", "resource_name": "attributes", "resource_type": "ssh_key", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "ssh_key", "source_system": "exavault"},
			},
		},
	})
	if err != nil {
