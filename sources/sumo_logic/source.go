...
const (
	...
	defaultHealthPath      = "/v1/collectors"
	defaultBaseURLTemplate = "https://api.sumologic.com/api"
	tokenHeader            = ""
	tokenScheme            = "Basic"
		...
		Families: []jsonapi.Family{
			{
				...
				Path:             "/v1/events",
				URNKind:          "sumo_logic_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "sumo_logic"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/detections",
				URNKind:          "sumo_logic_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "sumo_logic"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/assets",
				URNKind:          "sumo_logic_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "sumo_logic"},
			},
		},
	})
	if err != nil {
