...
const (
	sourceID               = "heroku"
	defaultFamily          = familyApps
	defaultHealthPath      = "/apps"
	defaultBaseURLTemplate = "https://api.heroku.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyApps             = "apps"
	familyCollaborators    = "collaborators"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "apps", "source_system": "heroku"},
			},
			{
				Name:             familyCollaborators,
				Path:             "/collaborators",
				URNKind:          "heroku_collaborators",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "collaborators", "source_system": "heroku"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/audit-events",
				URNKind:          "heroku_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "heroku"},
			},
		},
	})
	if err != nil {
