...
// NewFixture constructs the deterministic gsmtasks source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"account", "account_role", "client_role", "device", "email", "formrule", "notification", "notification_template", "task_event", "task_event_track", "user", "users_on_duty_log"} {
