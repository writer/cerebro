...
const (
	sourceID                     = "autotask"
	defaultFamily                = familyField
	defaultHealthPath            = "/V1.0/DeletedTaskActivityLogs/entityInformation/fields"
	defaultBaseURLTemplate       = "https://webservices5.autotask.net/ATServicesRest"
	tokenHeader                  = ""
	tokenScheme                  = "Bearer"
	familyField                  = "field"
	familyUserdefinedfield       = "userdefinedfield"
	familyExcludedrole           = "excludedrole"
	familyEntityinformationField = "entityinformation_field"
)

var templateKeys = []string{"parentid", "token"}
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			{
				Name:             familyField,
				Path:             "/V1.0/DeletedTaskActivityLogs/entityInformation/fields",
				URNKind:          "autotask_field",
				IDKeys:           []string{"name", "event_id", "id", "uuid", "request_id"},
				ListKeys:         []string{"fields"},
