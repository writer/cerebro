...
// NewFixture constructs the deterministic autotask source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"entityinformation_field", "excludedrole", "field", "userdefinedfield"} {
