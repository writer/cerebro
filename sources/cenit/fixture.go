...
// NewFixture constructs the deterministic cenit source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"connection", "connection_role", "data_type", "flow", "namespace", "observer", "scheduler", "schema", "setup_connection_role", "setup_webhook", "translator", "webhook"} {
