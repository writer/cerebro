...
const (
	sourceID                   = "cyberark_pam"
	defaultFamily              = familyUsers
	defaultHealthPath          = "/PasswordVault/api/Accounts"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "cyberark_pam"},
			},
			{
				Name:             familySecrets,
				Path:             "/v1/secrets",
				URNKind:          "cyberark_pam_secrets",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "secrets", "source_system": "cyberark_pam"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "cyberark_pam_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "cyberark_pam"},
			},
		},
	})
	if err != nil {
