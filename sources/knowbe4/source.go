...
const (
	...
	defaultBaseURLTemplate    = "https://${config.region}.api.knowbe4.com/v1"
	tokenHeader               = ""
	tokenScheme               = "Bearer"
	familyUsers               = "users"
	familyGroups              = "groups"
	familyTrainingEnrollments = "training_enrollments"
	familyPhishingCampaigns   = "phishing_campaigns"
)

var templateKeys = []string{"region", "token"}
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "knowbe4"},
			},
			{
				Name:             familyTrainingEnrollments,
				Path:             "/training/enrollments",
				URNKind:          "knowbe4_training_enrollments",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "training_enrollments", "source_system": "knowbe4"},
			},
			{
				Name:             familyPhishingCampaigns,
				Path:             "/phishing/campaigns",
				URNKind:          "knowbe4_phishing_campaigns",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "phishing_campaigns", "source_system": "knowbe4"},
			},
		},
	})
	if err != nil {
