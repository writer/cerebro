		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "perimeter81"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "perimeter81_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "perimeter81"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "perimeter81_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "perimeter81"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "perimeter81_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "perimeter81"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "perimeter81_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "perimeter81"},
			},
		},
	})
	if err != nil {
