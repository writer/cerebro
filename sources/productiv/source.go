		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "productiv"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "productiv_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "productiv"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "productiv_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "productiv"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "productiv_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "productiv"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "productiv_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "productiv"},
			},
		},
	})
	if err != nil {
