...
const (
	...
	defaultBaseURLTemplate = "https://api.cerebras.ai"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "cerebras"},
			},
			{
				Name:             familyApiKeys,
				Path:             "/v1/api-keys",
				URNKind:          "cerebras_api_keys",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "api_keys", "source_system": "cerebras"},
			},
			{
				Name:             familyUsageReports,
				Path:             "/v1/usage",
				URNKind:          "cerebras_usage_reports",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "usage_reports", "source_system": "cerebras"},
			},
			{
				Name:             familyModelDeployments,
				Path:             "/v1/deployments",
				URNKind:          "cerebras_model_deployments",
				...
				StaticAttributes: map[string]string{"record_class": "deployment", "schema": "model_deployments", "source_system": "cerebras"},
			},
		},
	})
	if err != nil {
