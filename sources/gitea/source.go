...
const (
	sourceID               = "gitea"
	defaultFamily          = familySearch
	defaultHealthPath      = "/repos/issues/search"
...
var templateKeys = []string{"index", "owner", "repo", "api_key"}
		...
		Families: []jsonapi.Family{
			{
				...
				URNKind:          "gitea_search",
				IDKeys:           []string{"id", "title", "finding_id", "resource_urn"},
				CursorParam:      "before",
				PageSizeParams:   []string{"limit"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"description": "description|summary", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "finding_id": "id", "id": "id", "name": "title", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "severity": "assets", "source_event_id": "event_id|id|metadata.event_id", "status": "state", "tenant_id": "tenant_id|metadata.tenant_id", "title": "title"},
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "search", "source_system": "gitea"},
			},
			{
				Name:             familyEmail,
				Path:             "/user/emails",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "email", "source_system": "gitea"},
			},
			{
				Name:             familyTeam,
				Path:             "/user/teams",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "team", "source_system": "gitea"},
			},
			{
				Name:             familyTimeline,
				Path:             "/repos/${config.owner}/${config.repo}/issues/${config.index}/timeline",
				URNKind:          "gitea_timeline",
				IDKeys:           []string{"id", "label", "event_id", "uuid", "request_id"},
				CursorParam:      "before",
				PageSizeParams:   []string{"limit"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "timeline", "source_system": "gitea"},
			},
		},
	})
	if err != nil {
