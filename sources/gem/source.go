		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "gem"},
			},
			{
				Name:             familyAccounts,
				Path:             "/v1/accounts",
				URNKind:          "gem_accounts",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "accounts", "source_system": "gem"},
			},
			{
				Name:             familyRecords,
				Path:             "/v1/records",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "records", "source_system": "gem"},
			},
			{
				Name:             familyPolicies,
				Path:             "/v1/policies",
				URNKind:          "gem_policies",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "policies", "source_system": "gem"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "gem_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "gem"},
			},
		},
	})
	if err != nil {
