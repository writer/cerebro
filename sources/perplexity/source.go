...
const (
	sourceID               = "perplexity"
	defaultFamily          = familyApiGroups
	defaultHealthPath      = "/models"
	defaultBaseURLTemplate = "https://api.perplexity.ai"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyApiGroups        = "api_groups"
	familyApiKeys          = "api_keys"
	familyTeamMembers      = "team_members"
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			{
				Name:             familyApiGroups,
				Path:             "/api-groups",
				URNKind:          "perplexity_api_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "api_groups", "source_system": "perplexity"},
			},
			{
				Name:             familyApiKeys,
				Path:             "/api-keys",
				URNKind:          "perplexity_api_keys",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "api_keys", "source_system": "perplexity"},
			},
			{
				Name:             familyTeamMembers,
				Path:             "/team/members",
				URNKind:          "perplexity_team_members",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "team_members", "source_system": "perplexity"},
			},
			{
				Name:             familyUsageReports,
				Path:             "/usage",
				URNKind:          "perplexity_usage_reports",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "usage_reports", "source_system": "perplexity"},
			},
		},
	})
	if err != nil {
