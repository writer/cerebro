		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "alert", "schema": "alerts", "source_system": "kentik"},
			},
			{
				Name:             familyIncidents,
				Path:             "/v1/incidents",
				URNKind:          "kentik_incidents",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "incidents", "source_system": "kentik"},
			},
			{
				Name:             familyMonitors,
				Path:             "/v1/monitors",
				URNKind:          "kentik_monitors",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "monitors", "source_system": "kentik"},
			},
			{
				Name:             familyDashboards,
				Path:             "/v1/dashboards",
				URNKind:          "kentik_dashboards",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "dashboards", "source_system": "kentik"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "kentik_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "kentik"},
			},
		},
	})
	if err != nil {
