...
// NewFixture constructs the deterministic telnyx source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"billing_group", "call_control_application", "call_event", "credential_connection", "detail_records_report", "managed_account", "notification_channel", "notification_event", "notification_event_condition", "sim_card_group", "sim_card_group_action", "wireless_connectivity_log"} {
