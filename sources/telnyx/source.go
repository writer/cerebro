		...
		Families: applyTelnyxDefaults([]jsonapi.Family{
			{
				...
				IDKeys:           []string{"call_leg_id", "call_session_id", "name"},
			...
			},
			{
				...
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"alert_fired_at": "created_at", "alert_id": "id", "alert_name": "channel_destination|id", "alert_source": "notification_profile_id", "alert_status": "channel_type_id", "alert_type": "channel_type_id", "id": "id", "name": "channel_destination|id", "observed_at": "updated_at|created_at", "resource_id": "id", "resource_name": "channel_destination|id", "resource_type": "channel_type_id", "source_event_id": "id"},
			...
			},
			{
				...
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"actor_id": "id", "event_type": "name|notification_category", "id": "id", "name": "name", "observed_at": "updated_at|created_at", "provider_id": "id", "resource_id": "id", "resource_name": "name", "resource_type": "notification_category", "source_event_id": "id"},
			...
			},
			{
				...
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"actor_id": "notification_event_id|id", "event_type": "name|associated_record_type", "id": "id", "name": "name", "observed_at": "updated_at|created_at", "provider_id": "id", "resource_id": "id", "resource_name": "name", "resource_type": "associated_record_type", "source_event_id": "id"},
			...
			},
			{
				...
				Attributes:       map[string]string{"actor_id": "sim_card_id", "event_type": "log_type", "id": "id", "name": "apn|log_type", "observed_at": "start_time|last_seen|created_at", "provider_id": "id", "resource_id": "sim_card_id|id", "resource_name": "apn|sim_card_id", "resource_type": "record_type|log_type", "source_event_id": "id"},
