...
// NewFixture constructs the deterministic optimizely_feature_experimentation source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"audit_events", "deployments", "projects", "repositories", "users"} {
