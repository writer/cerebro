...
// NewFixture constructs the deterministic discourse source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"backups_json", "groups_json", "notifications_json", "user_actions_json"} {
