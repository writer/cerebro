...
const (
	sourceID                   = "beyondtrust"
	defaultFamily              = familyUsers
	defaultHealthPath          = "/BeyondTrust/api/public/v3/Auth/Verify"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "beyondtrust"},
			},
			{
				Name:             familySecrets,
				Path:             "/v1/secrets",
				URNKind:          "beyondtrust_secrets",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "secrets", "source_system": "beyondtrust"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "beyondtrust_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "beyondtrust"},
			},
		},
	})
	if err != nil {
