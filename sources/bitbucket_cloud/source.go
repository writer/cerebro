...
const (
	sourceID               = "bitbucket_cloud"
	defaultFamily          = familyRepositories
	defaultHealthPath      = "/2.0/user"
	defaultBaseURLTemplate = "https://api.bitbucket.org"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://api.bitbucket.org/oauth/token",
		Families: []jsonapi.Family{
			{
				Name:             familyRepositories,
				Path:             "/v1/repositories",
				URNKind:          "bitbucket_cloud_repositories",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "bitbucket_cloud"},
			},
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "bitbucket_cloud_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "bitbucket_cloud"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "bitbucket_cloud_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "bitbucket_cloud"},
			},
		},
	})
	if err != nil {
