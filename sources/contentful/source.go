		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "contentful"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "contentful_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "contentful"},
			},
			{
				Name:             familyWorkspaces,
				Path:             "/v1/workspaces",
				URNKind:          "contentful_workspaces",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "workspaces", "source_system": "contentful"},
			},
			{
			...
			},
			{
				...
				URNKind:          "contentful_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "contentful"},
			},
		},
	})
	if err != nil {
