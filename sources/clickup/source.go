...
const (
	...
	defaultBaseURLTemplate = "https://api.clickup.com/api"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "clickup"},
			},
			{
				Name:             familyProjects,
				Path:             "/v1/projects",
				URNKind:          "clickup_projects",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "clickup"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "clickup_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "clickup"},
			},
		},
	})
	if err != nil {
