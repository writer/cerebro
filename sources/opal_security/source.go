		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "opal_security"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "opal_security_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "opal_security"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "opal_security_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "opal_security"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "opal_security_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "opal_security"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "opal_security_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "opal_security"},
			},
		},
	})
	if err != nil {
