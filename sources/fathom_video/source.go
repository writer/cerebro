		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "fathom_video"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "fathom_video_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "fathom_video"},
			},
			{
				Name:             familyWorkspaces,
				Path:             "/v1/workspaces",
				URNKind:          "fathom_video_workspaces",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "workspaces", "source_system": "fathom_video"},
			},
			{
				Name:             familyDocuments,
				Path:             "/v1/documents",
				URNKind:          "fathom_video_documents",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "documents", "source_system": "fathom_video"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "fathom_video_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "fathom_video"},
			},
		},
	})
	if err != nil {
