		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "frontegg"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "frontegg_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "frontegg"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "frontegg_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "frontegg"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "frontegg_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "frontegg"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "frontegg_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "frontegg"},
			},
		},
	})
	if err != nil {
