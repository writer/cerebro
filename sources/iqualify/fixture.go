...
// NewFixture constructs the deterministic iqualify source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"courses", "current", "future", "group", "learner", "learners_progress", "progress", "pulses", "responses", "social_note", "unit_reaction", "user"} {
