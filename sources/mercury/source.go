...
const (
	...
	defaultBaseURLTemplate = "https://api.mercury.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "accounts", "source_system": "mercury"},
			},
			{
				Name:             familyTransactions,
				Path:             "/v1/transactions",
				URNKind:          "mercury_transactions",
				IDKeys:           []string{"id", "event_id", "uuid", "request_id"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				ListKeys:         []string{"transactions"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "transactions", "source_system": "mercury"},
			},
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "mercury_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "mercury"},
			},
		},
	})
	if err != nil {
