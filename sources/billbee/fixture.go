...
// NewFixture constructs the deterministic billbee source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"addresses", "cloudstorage", "custom_field", "customer", "customer_addresses", "image", "layout", "order", "product", "shipment", "stock", "webhook"} {
