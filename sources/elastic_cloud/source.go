		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "alert", "schema": "alerts", "source_system": "elastic_cloud"},
			},
			{
				Name:             familyIncidents,
				Path:             "/v1/incidents",
				URNKind:          "elastic_cloud_incidents",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "incidents", "source_system": "elastic_cloud"},
			},
			{
				Name:             familyMonitors,
				Path:             "/v1/monitors",
				URNKind:          "elastic_cloud_monitors",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "monitors", "source_system": "elastic_cloud"},
			},
			{
				Name:             familyDashboards,
				Path:             "/v1/dashboards",
				URNKind:          "elastic_cloud_dashboards",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "dashboards", "source_system": "elastic_cloud"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "elastic_cloud_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "elastic_cloud"},
			},
		},
	})
	if err != nil {
