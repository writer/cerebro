...
// NewFixture constructs the deterministic fireworks_ai source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"audit_logs", "billing_metrics", "model_deployments", "service_accounts"} {
