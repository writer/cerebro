...
// NewFixture constructs the deterministic api2cart source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"attribute_attributeset_list_json", "attribute_group_list_json"} {
