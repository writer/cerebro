...
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{familyActivityLog, "activity_log_alert", familyAKSCluster, familyAppRoleAssignment, familyAppService, familyApplication, "application_gateway", "application_insight", familyAssetMetadata, "cognitive_services_account", familyContainerRegistry, familyCosmosAccount, familyCredential, "databricks_workspace", familyDirectoryAudit, familyDirectoryRoleAssign, familyEffectivePermission, familyFunctionApp, familyGroup, familyGroupMember, familyIAMRoleAssign, familyKeyVault, familyKeyVaultKey, familyKeyVaultSecret, "load_balancer", "log_alert", "machine_learning_workspace", familyManagedDisk, "metric_alert_rule", familyNetworkSecurityGrp, familyPublicIPAddress, familyResourceExposure, "role", "route_table", "security_contact", familyServicePrincipal, familySQLDatabase, "sql_managed_instance", familySQLServer, familyStorageAccount, familySubnet, familyUser, familyVirtualMachine, "virtual_machine_scale_set", familyVirtualNetwork} {
