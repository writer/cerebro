...
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{familyActivityLog, "activity_log_alert", familyAKSCluster, familyAppRoleAssignment, familyAppService, familyApplication, "application_container", "application_gateway", "application_insight", familyAssetMetadata, "cognitive_services_account", familyContainerRegistry, familyCosmosAccount, "cosmos_postgresql", familyCredential, "databricks_workspace", "defender_config", "diagnostic_setting", familyDirectoryAudit, familyDirectoryRoleAssign, familyEffectivePermission, familyFunctionApp, familyGroup, familyGroupMember, familyIAMRoleAssign, familyKeyVault, familyKeyVaultKey, familyKeyVaultSecret, "load_balancer", "log_alert", "machine_learning_workspace", familyManagedDisk, "metric_alert_rule", familyNetworkSecurityGrp, "postgresql_server", familyPublicIPAddress, familyResourceExposure, "role", "route_table", "security_contact", familyServicePrincipal, familySQLDatabase, "sql_managed_instance", familySQLServer, "sql_server_on_virtual_machine", familyStorageAccount, familySubnet, familyUser, familyVirtualMachine, "virtual_machine_scale_set", familyVirtualNetwork} {
