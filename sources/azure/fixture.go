...
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{familyActivityLog, familyAKSCluster, familyAppRoleAssignment, familyAppService, familyApplication, familyAssetMetadata, "cognitive_services_account", familyContainerRegistry, familyCosmosAccount, familyCredential, familyDirectoryAudit, familyDirectoryRoleAssign, familyEffectivePermission, familyFunctionApp, familyGroup, familyGroupMember, familyIAMRoleAssign, familyKeyVault, familyKeyVaultKey, familyKeyVaultSecret, "machine_learning_workspace", familyManagedDisk, familyNetworkSecurityGrp, familyPublicIPAddress, familyResourceExposure, familyServicePrincipal, familySQLDatabase, familySQLServer, familyStorageAccount, familyUser, familyVirtualMachine, familyVirtualNetwork} {
