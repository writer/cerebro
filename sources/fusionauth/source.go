		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "fusionauth"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "fusionauth_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "fusionauth"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "fusionauth_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "fusionauth"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "fusionauth_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "fusionauth"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "fusionauth_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "fusionauth"},
			},
		},
	})
	if err != nil {
