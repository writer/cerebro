...
const (
	...
	defaultHealthPath      = "/wiki/rest/api/user/current"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "confluence"},
			},
			{
				Name:             familyProjects,
				Path:             "/v1/projects",
				URNKind:          "confluence_projects",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "confluence"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "confluence_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "confluence"},
			},
		},
	})
	if err != nil {
