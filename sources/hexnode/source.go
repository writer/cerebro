		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "hexnode"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "hexnode_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "hexnode"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "hexnode_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "hexnode"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "hexnode_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "hexnode"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "hexnode_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "hexnode"},
			},
		},
	})
	if err != nil {
