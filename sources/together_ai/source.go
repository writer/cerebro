...
const (
	sourceID               = "together_ai"
	defaultFamily          = familyProjects
	defaultHealthPath      = "/v1/models"
	defaultBaseURLTemplate = "https://api.together.xyz"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "together_ai"},
			},
			{
				Name:             familyApiKeys,
				Path:             "/v1/api-keys",
				URNKind:          "together_ai_api_keys",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "api_keys", "source_system": "together_ai"},
			},
			{
				Name:             familyUsageReports,
				Path:             "/v1/usage",
				URNKind:          "together_ai_usage_reports",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "usage_reports", "source_system": "together_ai"},
			},
			{
				Name:             familyFineTuningJobs,
				Path:             "/v1/fine-tunes",
				URNKind:          "together_ai_fine_tuning_jobs",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				DisablePageSize:  true,
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "id", "resource_name": "name", "resource_type": "resource_type|type|kind", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "fine_tuning_jobs", "source_system": "together_ai"},
			},
		},
	})
	if err != nil {
