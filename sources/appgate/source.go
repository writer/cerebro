		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "appgate"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "appgate_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "appgate"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "appgate_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "appgate"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "appgate_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "appgate"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "appgate_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "appgate"},
			},
		},
	})
	if err != nil {
