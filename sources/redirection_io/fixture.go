...
// NewFixture constructs the deterministic redirection_io source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"agent_rule", "agent_rule_complexe", "agent_rule_straight", "aggregate_log", "export_rule", "log", "notification", "rule", "rule_change", "rule_set_version", "smart_list", "user"} {
