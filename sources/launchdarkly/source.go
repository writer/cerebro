...
const (
	...
	defaultBaseURLTemplate = "https://app.launchdarkly.com/api"
	tokenHeader            = ""
	tokenScheme            = "Token"
		...
		Families: []jsonapi.Family{
			{
				...
				URNKind:          "launchdarkly_repositories",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "launchdarkly"},
			},
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "launchdarkly_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "launchdarkly"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "launchdarkly_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "launchdarkly"},
			},
		},
	})
	if err != nil {
