		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "cerby"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "cerby_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "cerby"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "cerby"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "cerby_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "cerby"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "cerby_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "cerby"},
			},
		},
	})
	if err != nil {
