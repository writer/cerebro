...
var DefaultDefinitions = []Definition{
	...
	{Name: "security_setting", Label: "azure security settings", ProviderPath: "Microsoft.Security/settings", APIVersion: "2022-05-01", Kind: "azure.security_setting", SchemaRef: "azure/security_setting/v1"},
