...
const (
	sourceID               = "elastic_security"
	defaultFamily          = familyAuditEvents
	defaultHealthPath      = "/api/status"
	defaultBaseURLTemplate = "https://${config.elastic_url}"
	tokenHeader            = ""
	tokenScheme            = "Token"
...
var templateKeys = []string{"api_key", "elastic_url"}
		...
		Families: []jsonapi.Family{
			{
				...
				Path:             "/v1/events",
				URNKind:          "elastic_security_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "elastic_security"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/detections",
				URNKind:          "elastic_security_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "elastic_security"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/assets",
				URNKind:          "elastic_security_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "elastic_security"},
			},
		},
	})
	if err != nil {
