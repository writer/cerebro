		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "firefly"},
			},
			{
				Name:             familyProjects,
				Path:             "/v1/projects",
				URNKind:          "firefly_projects",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "firefly"},
			},
			{
				Name:             familyRepositories,
				Path:             "/v1/repositories",
				URNKind:          "firefly_repositories",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "firefly"},
			},
			{
				Name:             familyDeployments,
				Path:             "/v1/deployments",
				URNKind:          "firefly_deployments",
				...
				StaticAttributes: map[string]string{"record_class": "deployment", "schema": "deployments", "source_system": "firefly"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "firefly_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "firefly"},
			},
		},
	})
	if err != nil {
