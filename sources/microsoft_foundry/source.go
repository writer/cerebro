...
const (
	sourceID               = "microsoft_foundry"
	defaultFamily          = familyAgents
	defaultHealthPath      = "/agents?api-version=v1"
	defaultBaseURLTemplate = "https://${config.endpoint}/api/projects/${config.project_name}"
	tokenHeader            = "api-key"
	tokenScheme            = "Token"
	familyAgents           = "agents"
	familyDatasets         = "datasets"
	familyIndexes          = "indexes"
	familyEvaluations      = "evaluations"
	familyConnections      = "connections"
)

var templateKeys = []string{"endpoint", "project_name", "api_key"}
		...
		Families: []jsonapi.Family{
			{
				Name:             familyAgents,
				Path:             "/agents",
				URNKind:          "microsoft_foundry_agents",
				...
				StaticAttributes: map[string]string{"record_class": "deployment", "schema": "agents", "source_system": "microsoft_foundry"},
				Config: jsonapi.FamilyConfig{
					StaticQuery: map[string]string{"api-version": "v1"},
				},
			},
			{
				Name:             familyDatasets,
				Path:             "/datasets",
				URNKind:          "microsoft_foundry_datasets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "datasets", "source_system": "microsoft_foundry"},
				Config: jsonapi.FamilyConfig{
					StaticQuery: map[string]string{"api-version": "v1"},
				},
			},
			{
				Name:             familyIndexes,
				Path:             "/indexes",
				URNKind:          "microsoft_foundry_indexes",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				DisablePageSize:  true,
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "id", "resource_name": "name", "resource_type": "resource_type|type|kind", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "indexes", "source_system": "microsoft_foundry"},
				Config: jsonapi.FamilyConfig{
					StaticQuery: map[string]string{"api-version": "v1"},
				},
			},
			{
				Name:             familyEvaluations,
				Path:             "/evaluations",
				URNKind:          "microsoft_foundry_evaluations",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "evaluations", "source_system": "microsoft_foundry"},
				Config: jsonapi.FamilyConfig{
					StaticQuery: map[string]string{"api-version": "v1"},
				},
			},
			{
				...
				Path:             "/connections",
				URNKind:          "microsoft_foundry_connections",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				DisablePageSize:  true,
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "id", "resource_name": "name", "resource_type": "resource_type|type|kind", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "connections", "source_system": "microsoft_foundry"},
				Config: jsonapi.FamilyConfig{
					StaticQuery: map[string]string{"api-version": "v1"},
				},
			},
