...
// NewFixture constructs the deterministic microsoft_foundry source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"agents", "connections", "datasets", "evaluations", "indexes"} {
