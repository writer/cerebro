		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "jfrog_artifactory_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "jfrog_artifactory"},
			},
			{
				Name:             familyProjects,
				Path:             "/v1/projects",
				URNKind:          "jfrog_artifactory_projects",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "jfrog_artifactory"},
			},
			{
				Name:             familyRepositories,
				Path:             "/v1/repositories",
				URNKind:          "jfrog_artifactory_repositories",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "jfrog_artifactory"},
			},
			{
				Name:             familyDeployments,
				Path:             "/v1/deployments",
				URNKind:          "jfrog_artifactory_deployments",
				...
				StaticAttributes: map[string]string{"record_class": "deployment", "schema": "deployments", "source_system": "jfrog_artifactory"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "jfrog_artifactory_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "jfrog_artifactory"},
			},
		},
	})
	if err != nil {
