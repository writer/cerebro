...
// NewFixture constructs the deterministic neutrinoapi source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"bin_lookup", "geocode_address", "host_reputation", "ip_blocklist"} {
