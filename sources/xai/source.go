		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "api_keys", "source_system": "xai"},
			},
			{
				Name:             familyAuditLogs,
				Path:             "/management/audit-logs",
				URNKind:          "xai_audit_logs",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_logs", "source_system": "xai"},
			},
			{
				Name:             familyUsageReports,
				Path:             "/management/usage",
				URNKind:          "xai_usage_reports",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "usage_reports", "source_system": "xai"},
			},
			{
				Name:             familyModelAccess,
				Path:             "/management/model-access",
				URNKind:          "xai_model_access",
				IDKeys:           []string{"id", "model", "urn", "resource_urn", "name"},
				DisablePageSize:  true,
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "id", "resource_name": "model", "resource_type": "resource_type|type|kind", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "model_access", "source_system": "xai"},
			},
		},
	})
	if err != nil {
