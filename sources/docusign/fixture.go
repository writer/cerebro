...
// NewFixture constructs the deterministic docusign source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"bcc_email_archive", "permission_profile", "request_log", "signing_group"} {
