...
const (
	sourceID                = "docusign"
	defaultFamily           = familyBccEmailArchive
	defaultHealthPath       = "/v2.1/accounts/${config.accountid}/settings/bcc_email_archives"
	defaultBaseURLTemplate  = "https://www.docusign.net/restapi"
	tokenHeader             = ""
	tokenScheme             = "Bearer"
	familyBccEmailArchive   = "bcc_email_archive"
	familySigningGroup      = "signing_group"
	familyRequestLog        = "request_log"
	familyPermissionProfile = "permission_profile"
)

var templateKeys = []string{"accountid", "token"}
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			{
				Name:             familyBccEmailArchive,
				Path:             "/v2.1/accounts/${config.accountid}/settings/bcc_email_archives",
				URNKind:          "docusign_bcc_email_archive",
				IDKeys:           []string{"email", "user_id", "id", "primary_email", "login"},
				PageSizeParams:   []string{"count"},
				ListKeys:         []string{"bccEmailArchives"},
