		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "delinea"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "delinea_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "delinea"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "delinea_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "delinea"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "delinea_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "delinea"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "delinea_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "delinea"},
			},
		},
	})
	if err != nil {
