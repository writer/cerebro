...
// NewFixture constructs the deterministic huggingface source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"audit_logs", "organization_members", "repositories", "resource_groups"} {
