...
const (
	sourceID               = "terraform_cloud"
	defaultFamily          = familyRepositories
	defaultHealthPath      = "/v2/account/details"
	defaultBaseURLTemplate = "https://app.terraform.io/api"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				URNKind:          "terraform_cloud_repositories",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "terraform_cloud"},
			},
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "terraform_cloud_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "terraform_cloud"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "terraform_cloud_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "terraform_cloud"},
			},
		},
	})
	if err != nil {
