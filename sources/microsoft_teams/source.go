...
const (
	sourceID                   = "microsoft_teams"
	defaultFamily              = familyUsers
	defaultHealthPath          = "/v1.0/teams"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "microsoft_teams"},
			},
			{
				Name:             familyContentAssets,
				Path:             "/v1/resources",
				URNKind:          "microsoft_teams_content_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "content_assets", "source_system": "microsoft_teams"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "microsoft_teams_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "microsoft_teams"},
			},
		},
	})
	if err != nil {
