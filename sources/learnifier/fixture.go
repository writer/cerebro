...
// NewFixture constructs the deterministic learnifier source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"coursedesign", "globalusergroup", "member", "orgunit", "orgunits_usergroup", "participant", "project", "teammember", "user", "usergroup", "usergroups_member"} {
