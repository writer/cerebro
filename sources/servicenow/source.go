...
const (
	...
	defaultHealthPath      = "/api/now/table/sys_user"
	defaultBaseURLTemplate = "https://${config.instance}.service-now.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
...
var templateKeys = []string{"client_id", "client_secret", "instance"}
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://${config.instance}.service-now.com/oauth/token",
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "servicenow_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "servicenow"},
			},
			{
				Name:             familyTickets,
				Path:             "/v1/tickets",
				URNKind:          "servicenow_tickets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "tickets", "source_system": "servicenow"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "servicenow_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "servicenow"},
			},
		},
	})
	if err != nil {
