...
const (
	...
	defaultHealthPath      = "/crm/v3/objects/contacts"
	defaultBaseURLTemplate = "https://api.hubapi.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
	familyAssets           = "assets"
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://api.hubapi.com/oauth/token",
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "hubspot_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "hubspot"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/records",
				URNKind:          "hubspot_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "hubspot"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "hubspot_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "hubspot"},
			},
		},
	})
	if err != nil {
