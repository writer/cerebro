		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "devtron"},
			},
			{
				Name:             familyProjects,
				Path:             "/v1/projects",
				URNKind:          "devtron_projects",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "devtron"},
			},
			{
				Name:             familyRepositories,
				Path:             "/v1/repositories",
				URNKind:          "devtron_repositories",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "devtron"},
			},
			{
				Name:             familyDeployments,
				Path:             "/v1/deployments",
				URNKind:          "devtron_deployments",
				...
				StaticAttributes: map[string]string{"record_class": "deployment", "schema": "deployments", "source_system": "devtron"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "devtron_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "devtron"},
			},
		},
	})
	if err != nil {
