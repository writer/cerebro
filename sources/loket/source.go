...
const (
	sourceID                         = "loket"
	defaultFamily                    = familyIntegration
	defaultHealthPath                = "/users/integrations"
	defaultBaseURLTemplate           = "https://api.loket.nl/v2"
	tokenHeader                      = ""
	tokenScheme                      = "Bearer"
	familyIntegration                = "integration"
	familyActualorganizationalentity = "actualorganizationalentity"
	familyEmailidentity              = "emailidentity"
	familyCustomnotification         = "customnotification"
)

var templateKeys = []string{"employerid", "employmentid", "token"}
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "emailidentity", "source_system": "loket"},
			},
			{
				Name:             familyCustomnotification,
				Path:             "/providers/employers/employees/employments/${config.employmentid}/customnotifications",
				URNKind:          "loket_customnotification",
				IDKeys:           []string{"id", "description", "alert_id", "sid", "incident_id", "uuid"},
				PageSizeParams:   []string{"pageSize"},
				ListKeys:         []string{"messages"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"alert_description": "description|summary|message|body", "alert_fired_at": "fired_at|triggered_at|created_at|occurred_at|timestamp", "alert_id": "id", "alert_name": "description", "alert_resolved_at": "resolved_at|closed_at|acknowledged_at", "alert_severity": "code", "alert_source": "source|alert_source|monitor|check", "alert_status": "code", "alert_type": "alert_type|type|category|kind", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "name": "description", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "alert", "schema": "customnotification", "source_system": "loket"},
			},
		},
	})
	if err != nil {
