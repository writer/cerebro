...
// NewFixture constructs the deterministic loket source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"actualorganizationalentity", "customnotification", "emailidentity", "integration"} {
