...
const (
	...
	defaultHealthPath      = "/v2/requesters/me"
	defaultBaseURLTemplate = "https://${config.domain}.freshservice.com/api"
	tokenHeader            = ""
	tokenScheme            = "Token"
	familyUsers            = "users"
...
var templateKeys = []string{"api_key", "domain"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "freshservice"},
			},
			{
				Name:             familyTickets,
				Path:             "/v1/tickets",
				URNKind:          "freshservice_tickets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "tickets", "source_system": "freshservice"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "freshservice_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "freshservice"},
			},
		},
	})
	if err != nil {
