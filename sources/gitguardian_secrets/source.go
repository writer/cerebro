		...
		Families: []jsonapi.Family{
			{
				Name:             familySecrets,
				Path:             "/v1/secrets",
				URNKind:          "gitguardian_secrets_secrets",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "secrets", "source_system": "gitguardian_secrets"},
			},
			{
				Name:             familySources,
				Path:             "/v1/sources",
				URNKind:          "gitguardian_secrets_sources",
			...
			},
			{
				...
				Path:             "/v1/audit_logs",
				URNKind:          "gitguardian_secrets_audit_events",
