...
const (
	...
	familyContinent        = "continent"
)

var templateKeys = []string{"teamid", "api_key"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "team", "source_system": "appwrite"},
			},
			{
				Name:             familyLog,
				Path:             "/account/logs",
				URNKind:          "appwrite_log",
				IDKeys:           []string{"clientCode", "event_id", "id", "uuid", "request_id"},
				ListKeys:         []string{"logs"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"actor_email": "actor_email|actor.email|email|user.email", "actor_id": "actor_id|actor.id|actorId|user_id|user.id", "actor_name": "actor_name|actor.name|user.name", "event_type": "event_type|event_name|action|type", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "clientCode", "name": "clientCode", "observed_at": "observed_at|updated_at|last_seen_at", "provider_id": "clientCode", "resource_email": "resource_email|target_email|target.email", "resource_id": "resource_id|target_id|target.id|resource.id|object_id", "resource_name": "resource_name|target_name|target.name|resource.name|object_name", "resource_type": "resource_type|target_type|target.type|object_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "log", "source_system": "appwrite"},
			},
			{
				Name:             familyMembership,
				Path:             "/teams/${config.teamid}/memberships",
				URNKind:          "appwrite_membership",
				IDKeys:           []string{"name", "membership_id", "id", "group_id", "member_id", "user_id", "email"},
				PageSizeParams:   []string{"limit"},
				ListKeys:         []string{"memberships"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "group_email": "group_email|group.email", "group_id": "group_id|group.id|groupId", "group_name": "group_name|group.name", "id": "name", "member_email": "member_email|user_email|email|member.email|user.email", "member_id": "member_id|member.id|user_id|user.id|id", "member_name": "member_name|name|member.name|user.name", "member_type": "member_type|type|member.type", "member_user_id": "member_user_id|user_id|user.id|member.id", "name": "name", "observed_at": "observed_at|updated_at|last_seen_at", "provider_id": "name", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "role": "role|membership_role", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "group_membership", "schema": "membership", "source_system": "appwrite"},
			},
			{
