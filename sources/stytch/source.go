		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "stytch"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "stytch_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "stytch"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "stytch_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "stytch"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "stytch_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "stytch"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "stytch_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "stytch"},
			},
		},
	})
	if err != nil {
