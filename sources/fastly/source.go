		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "resource_type": "service", "schema": "services", "source_system": "fastly"},
				Config: jsonapi.FamilyConfig{
					ConfigAttributes: map[string]string{"tenant_id": "tenant_id"},
					ResourceURNKind:  "fastly_services",
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "resource_type": "acl_entry", "schema": "acl_entries", "source_system": "fastly"},
				Config: jsonapi.FamilyConfig{
					ConfigAttributes: map[string]string{"acl_id": "acl_id", "service_id": "service_id", "tenant_id": "tenant_id"},
					ResourceURNKind:  "fastly_acl_entries",
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "resource_type": "audit_event", "schema": "audit_events", "source_system": "fastly"},
