		...
		Families: []jsonapi.Family{
			{
				...
				Attributes:       map[string]string{"description": "description|summary", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "finding_id": "id", "id": "id", "name": "title|label|name|summary|id", "observed_at": "observed_at|updated_at|last_seen_at|created", "resource_id": "resource_id|entity.id|id|metadata.resource_id", "resource_name": "resource_name|entity.label|entity.label_display|name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|entity.type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "severity": "severity|priority|level|risk", "source_event_id": "event_id|id|metadata.event_id", "status": "status|state", "tenant_id": "tenant_id|metadata.tenant_id", "title": "title|label|name|summary|id"},
