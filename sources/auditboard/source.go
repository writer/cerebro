...
const (
	...
	defaultHealthPath          = "/api/v1/users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "auditboard"},
			},
			{
				Name:             familyControls,
				Path:             "/v1/controls",
				URNKind:          "auditboard_controls",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "controls", "source_system": "auditboard"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/findings",
				URNKind:          "auditboard_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "auditboard"},
			},
		},
	})
	if err != nil {
