...
const (
	...
	defaultHealthPath      = "/v1/users"
	defaultBaseURLTemplate = "https://app.strongdm.com/api"
	tokenHeader            = ""
	tokenScheme            = "Token"
	familyUsers            = "users"
	familyGroups           = "groups"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "strongdm"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "strongdm_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "strongdm"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "strongdm_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "strongdm"},
			},
		},
	})
	if err != nil {
