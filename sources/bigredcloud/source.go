...
const (
	sourceID               = "bigredcloud"
	defaultFamily          = familyAccount
	defaultHealthPath      = "/v1/accounts"
	defaultBaseURLTemplate = "https://app.bigredcloud.com/api"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyAccount          = "account"
	familyOwnertypegroup   = "ownertypegroup"
	familyAnalysiscategory = "analysiscategory"
	familyBankaccount      = "bankaccount"
)
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "account", "source_system": "bigredcloud"},
			},
			{
				Name:             familyOwnertypegroup,
				Path:             "/v1/ownerTypeGroups",
				URNKind:          "bigredcloud_ownertypegroup",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "ownertypegroup", "source_system": "bigredcloud"},
			},
			{
				Name:             familyAnalysiscategory,
				Path:             "/v1/analysisCategories",
				URNKind:          "bigredcloud_analysiscategory",
				IDKeys:           []string{"id", "description", "urn", "resource_urn", "name"},
				ListKeys:         []string{"Items"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "name": "description", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "id", "resource_name": "description", "resource_type": "analysiscategory", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "analysiscategory", "source_system": "bigredcloud"},
			},
			{
				Name:             familyBankaccount,
				Path:             "/v1/bankAccounts",
				URNKind:          "bigredcloud_bankaccount",
				IDKeys:           []string{"id", "acCode", "user_id", "email", "primary_email", "login"},
				ListKeys:         []string{"Items"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"created_at": "created_at|created|profile.created_at", "department": "department|profile.department", "display_name": "display_name|name|profile.display_name|profile.name", "domain": "domain|tenant_domain|organization_domain", "email": "email|primary_email|profile.email", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "job_title": "job_title|title|profile.title", "last_login_at": "last_login_at|last_login|last_seen_at", "login": "login|username|email|profile.login", "manager": "manager|profile.manager", "name": "acCode", "observed_at": "observed_at|updated_at|last_seen_at", "primary_email": "primary_email|email|profile.email", "provider_id": "id", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "status": "status|state|lifecycle_state", "tenant_id": "tenant_id|metadata.tenant_id", "user_id": "user_id|id|uid"},
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "bankaccount", "source_system": "bigredcloud"},
			},
		},
	})
	if err != nil {
