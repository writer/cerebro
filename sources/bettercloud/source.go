		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "bettercloud"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "bettercloud_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "bettercloud"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "bettercloud_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "bettercloud"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "bettercloud_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "bettercloud"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "bettercloud_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "bettercloud"},
			},
		},
	})
	if err != nil {
