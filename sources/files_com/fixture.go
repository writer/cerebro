...
// NewFixture constructs the deterministic files_com source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"action_notification_export_result", "api_key", "exavault_reserved", "external_event", "group", "group_user", "login", "permission", "site_api_key", "user", "user_api_key", "user_group"} {
