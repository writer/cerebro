...
const (
	...
	defaultBaseURLTemplate = "https://api.swif.ai"
	tokenHeader            = ""
	tokenScheme            = "Token"
	familyUsers            = "users"
	familyDevices          = "devices"
	familyDeviceCompliance = "device_compliance"
)
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "swif_ai"},
			},
			{
				Name:             familyDevices,
				Path:             "/v1/devices",
				URNKind:          "swif_ai_devices",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "devices", "source_system": "swif_ai"},
			},
			{
				Name:             familyDeviceCompliance,
				Path:             "/v1/device-compliance",
				URNKind:          "swif_ai_device_compliance",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "device_compliance", "source_system": "swif_ai"},
			},
		},
	})
	if err != nil {
