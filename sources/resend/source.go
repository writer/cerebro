...
const (
	sourceID               = "resend"
	defaultFamily          = familyDomains
	defaultHealthPath      = "/domains"
	defaultBaseURLTemplate = "https://api.resend.com"
	tokenHeader            = ""
	tokenScheme            = "Token"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "domains", "source_system": "resend"},
			},
			{
				Name:             familyApiKeys,
				Path:             "/api-keys",
				URNKind:          "resend_api_keys",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "api_keys", "source_system": "resend"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/audit/events",
				URNKind:          "resend_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "resend"},
			},
		},
	})
	if err != nil {
