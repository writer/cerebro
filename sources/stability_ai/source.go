...
const (
	...
	defaultFamily          = familyEngines
	defaultHealthPath      = "/v1/engines/list"
	defaultBaseURLTemplate = "https://api.stability.ai"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyEngines          = "engines"
	familyAccount          = "account"
	familyAccountBalance   = "account_balance"
)
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "engines", "source_system": "stability_ai"},
			},
			{
				Name:             familyAccount,
				Path:             "/v1/user/account",
				URNKind:          "stability_ai_account",
				IDKeys:           []string{"id", "email", "urn", "resource_urn", "name"},
				DisablePageSize:  true,
				Singleton:        true,
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "id", "resource_name": "email", "resource_type": "resource_type|type|kind", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "account", "source_system": "stability_ai"},
			},
			{
				Name:             familyAccountBalance,
				Path:             "/v1/user/balance",
				URNKind:          "stability_ai_account_balance",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "account_balance", "source_system": "stability_ai"},
			},
		},
	})
	if err != nil {
