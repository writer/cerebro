...
const (
	...
	defaultHealthPath      = "/v1/organizations/${config.organizationid}/auditlogs"
	defaultBaseURLTemplate = "https://api.configcat.com"
	tokenHeader            = ""
	tokenScheme            = "Basic"
	familyAuditlog         = "auditlog"
	familyOrganization     = "organization"
	familyMember           = "member"
	familyPermission       = "permission"
)

var templateKeys = []string{"organizationid", "productid", "password", "username"}
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "organization", "source_system": "configcat"},
			},
			{
				Name:             familyMember,
				Path:             "/v1/organizations/${config.organizationid}/members",
				URNKind:          "configcat_member",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "member", "source_system": "configcat"},
			},
			{
				Name:             familyPermission,
				Path:             "/v1/products/${config.productid}/permissions",
				URNKind:          "configcat_permission",
				IDKeys:           []string{"name", "id", "urn", "resource_urn"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "name", "name": "name", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "name", "resource_name": "name", "resource_type": "permission", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "permission", "source_system": "configcat"},
			},
		},
	})
	if err != nil {
