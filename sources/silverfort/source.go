		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "silverfort"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "silverfort_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "silverfort"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "silverfort_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "silverfort"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "silverfort_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "silverfort"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "silverfort_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "silverfort"},
			},
		},
	})
	if err != nil {
