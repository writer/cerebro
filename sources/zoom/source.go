...
const (
	...
	defaultHealthPath          = "/v2/users/me"
	defaultBaseURLTemplate     = "https://api.zoom.us"
	tokenHeader                = ""
	tokenScheme                = "Bearer"
	oauthTokenURLTemplate      = "https://api.zoom.us/oauth/token" // #nosec G101 -- token endpoint URL template, not credential material.
	oauthScopeSeparator        = " "
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://api.zoom.us/oauth/token",
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "zoom"},
			},
			{
				Name:             familyContentAssets,
				Path:             "/v1/resources",
				URNKind:          "zoom_content_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "content_assets", "source_system": "zoom"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "zoom_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "zoom"},
			},
		},
	})
	if err != nil {
