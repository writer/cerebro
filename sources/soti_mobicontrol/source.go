		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "soti_mobicontrol_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "soti_mobicontrol"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "soti_mobicontrol_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "soti_mobicontrol"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "soti_mobicontrol_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "soti_mobicontrol"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "soti_mobicontrol_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "soti_mobicontrol"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "soti_mobicontrol_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "soti_mobicontrol"},
			},
		},
	})
	if err != nil {
