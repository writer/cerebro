...
// NewFixture constructs the deterministic databricks source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"assets", "audit_events", "model_serving_endpoints", "vulnerabilities"} {
