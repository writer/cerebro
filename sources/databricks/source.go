...
const (
	...
	defaultHealthPath           = "/api/2.0/preview/scim/v2/Me"
	defaultBaseURLTemplate      = "https://${config.workspace_url}"
	tokenHeader                 = ""
	tokenScheme                 = "Bearer"
	familyAssets                = "assets"
	familyModelServingEndpoints = "model_serving_endpoints"
	familyAuditEvents           = "audit_events"
	familyVulnerabilities       = "vulnerabilities"
)

var templateKeys = []string{"workspace_url", "token"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "databricks"},
			},
			{
				Name:             familyModelServingEndpoints,
				Path:             "/v1/model-serving/endpoints",
				URNKind:          "databricks_model_serving_endpoints",
				...
				StaticAttributes: map[string]string{"record_class": "deployment", "schema": "model_serving_endpoints", "source_system": "databricks"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "databricks_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "databricks"},
			},
			{
				Name:             familyVulnerabilities,
				Path:             "/v1/vulnerabilities",
				URNKind:          "databricks_vulnerabilities",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "vulnerabilities", "source_system": "databricks"},
			},
		},
	})
	if err != nil {
