...
// NewFixture constructs the deterministic portswigger_enterprise source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"assets", "audit_events", "findings", "policies", "vulnerabilities"} {
