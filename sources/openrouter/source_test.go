...
func TestSourceReadsProviderShapedFamilies(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			attr: "secret_id",
			want: "f01d52606dc8f0a8303a7b5cc3fa07109c2e346cec7c0a16b40de462992ce943",
		},
		{
			...
			body: map[string]any{
				"data": []map[string]any{{
					"allowed_api_key_hashes": []string{"f01d52606dc8f0a8303a7b5cc3fa07109c2e346cec7c0a16b40de462992ce943"},
