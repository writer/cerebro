...
// NewFixture constructs the deterministic openrouter source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"api_keys", "organization_members", "provider_keys", "usage_reports"} {
