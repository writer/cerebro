		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "chargify"},
			},
			{
				Name:             familyAccounts,
				Path:             "/v1/accounts",
				URNKind:          "chargify_accounts",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "accounts", "source_system": "chargify"},
			},
			{
				Name:             familyRecords,
				Path:             "/v1/records",
				URNKind:          "chargify_records",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "records", "source_system": "chargify"},
			},
			{
				Name:             familyPolicies,
				Path:             "/v1/policies",
				URNKind:          "chargify_policies",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "policies", "source_system": "chargify"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "chargify_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "chargify"},
			},
		},
	})
	if err != nil {
