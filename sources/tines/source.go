...
const (
	...
	defaultHealthPath      = "/v1/user"
	defaultBaseURLTemplate = "https://${config.tenant}.tines.com/api"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
...
var templateKeys = []string{"token", "tenant"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "tines"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/cases",
				URNKind:          "tines_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "tines"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/assets",
				URNKind:          "tines_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "tines"},
			},
		},
	})
	if err != nil {
