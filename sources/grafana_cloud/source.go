		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "grafana_cloud"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/alerts",
				URNKind:          "grafana_cloud_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "grafana_cloud"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "grafana_cloud_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "grafana_cloud"},
			},
		},
	})
	if err != nil {
