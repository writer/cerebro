...
// NewFixture constructs the deterministic planview_adaptivework source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"audit_events", "documents", "groups", "users", "workspaces"} {
