...
const (
	sourceID               = "planview_adaptivework"
		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "planview_adaptivework_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "planview_adaptivework"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "planview_adaptivework_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "planview_adaptivework"},
			},
			{
				Name:             familyWorkspaces,
				Path:             "/v1/workspaces",
				URNKind:          "planview_adaptivework_workspaces",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "workspaces", "source_system": "planview_adaptivework"},
			},
			{
				Name:             familyDocuments,
				Path:             "/v1/documents",
				URNKind:          "planview_adaptivework_documents",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "documents", "source_system": "planview_adaptivework"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "planview_adaptivework_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "planview_adaptivework"},
			},
		},
	})
	if err != nil {
