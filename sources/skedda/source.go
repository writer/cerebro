		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "skedda"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "skedda_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "skedda"},
			},
			{
				Name:             familyWorkspaces,
				Path:             "/v1/workspaces",
				URNKind:          "skedda_workspaces",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "workspaces", "source_system": "skedda"},
			},
			{
				Name:             familyDocuments,
				Path:             "/v1/documents",
				URNKind:          "skedda_documents",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "documents", "source_system": "skedda"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "skedda_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "skedda"},
			},
		},
	})
	if err != nil {
