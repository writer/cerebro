...
// NewFixture constructs the deterministic sinao source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"access", "account", "accountcategory", "accounting_entry", "apps_organization", "invite", "organization", "person", "product", "productcategory", "productstock", "rule"} {
