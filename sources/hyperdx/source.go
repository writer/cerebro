		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "alert", "schema": "alerts", "source_system": "hyperdx"},
			},
			{
				Name:             familyIncidents,
				Path:             "/v1/incidents",
				URNKind:          "hyperdx_incidents",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "incidents", "source_system": "hyperdx"},
			},
			{
				Name:             familyMonitors,
				Path:             "/v1/monitors",
				URNKind:          "hyperdx_monitors",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "monitors", "source_system": "hyperdx"},
			},
			{
				Name:             familyDashboards,
				Path:             "/v1/dashboards",
				URNKind:          "hyperdx_dashboards",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "dashboards", "source_system": "hyperdx"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "hyperdx_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "hyperdx"},
			},
		},
	})
	if err != nil {
