		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "imprivata"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "imprivata_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "imprivata"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "imprivata_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "imprivata"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "imprivata_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "imprivata"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "imprivata_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "imprivata"},
			},
		},
	})
	if err != nil {
