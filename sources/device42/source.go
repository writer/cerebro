		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "device42"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "device42_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "device42"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "device42_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "device42"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "device42_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "device42"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "device42_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "device42"},
			},
		},
	})
	if err != nil {
