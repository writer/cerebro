	...
	return []jsonapi.Family{
		...
		},
		{
			...
			Attributes: map[string]string{
				...
				"application_name":  "software.name|package_name|name|value.software.name|value.package_name|value.package",
				"app_name":          "software.name|package_name|name|value.software.name|value.package_name|value.package",
				"package_name":      "package_name|software.name|name|value.package_name|value.software.name|value.package",
				"package":           "package_name|software.name|name|value.package_name|value.software.name|value.package",
