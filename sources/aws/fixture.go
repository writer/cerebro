...
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{familyAccessKey, familyAssetMetadata, familyCloudTrail, familyEC2Instance, familyECSService, familyECSTask, familyECSTaskDefinition, familyEKSCluster, familyEKSNodegroup, familyEKSFargateProfile, familyEKSPodIdentity, familyEffectivePermission, familyIAMGroup, familyIAMMembership, familyIAMRole, familyIAMRoleAssign, familyIAMRoleTrust, familyIAMUser, familyLambdaFunction, familyPublicEndpoint, familyResourceExposure} {
