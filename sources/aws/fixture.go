...
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{familyAccessKey, familyAssetMetadata, familyCloudTrail, familyEC2Instance, familyECSService, familyECSTaskDefinition, familyEffectivePermission, familyIAMGroup, familyIAMMembership, familyIAMRole, familyIAMRoleAssign, familyIAMRoleTrust, familyIAMUser, familyLambdaFunction, familyPublicEndpoint, familyResourceExposure} {
