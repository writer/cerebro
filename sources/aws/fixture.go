...
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{familyAccessKey, familyAssetMetadata, familyCloudTrail, familyDocDBCluster, familyDocDBInstance, familyEC2Instance, familyECRRepository, familyECSService, familyECSTask, familyECSTaskDefinition, familyEKSCluster, familyEKSNodegroup, familyEKSFargateProfile, familyEKSPodIdentity, familyEffectivePermission, familyIAMGroup, familyIAMMembership, familyIAMRole, familyIAMRoleAssign, familyIAMRoleTrust, familyIAMUser, familyKMSKey, familyLambdaFunction, familyNeptuneCluster, familyNeptuneInstance, familyPublicEndpoint, familyRDSInstance, familyRedshiftCluster, familyResourceExposure, familyS3Bucket, familySecret, familySNSTopic, familySQSQueue} {
