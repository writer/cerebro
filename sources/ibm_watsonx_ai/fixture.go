...
// NewFixture constructs the deterministic ibm_watsonx_ai source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"custom_models", "deployments", "foundation_model_specs", "foundation_model_tasks", "training_jobs"} {
