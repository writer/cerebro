	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "bitwarden"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "bitwarden_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "bitwarden"},
			},
			{
