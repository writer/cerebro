	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				IDKeys:           []string{"date", "type", "actingUserId", "memberId", "itemId", "collectionId", "groupId", "policyId", "secretId", "projectId", "serviceAccountId"},
				CursorParam:      "continuationToken",
				NextCursorKeys:   []string{"continuationToken"},
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"date", "observed_at", "updated_at", "last_seen_at"},
				Attributes:       map[string]string{"actor_id": "actingUserId", "event_type": "type", "observed_at": "date", "resource_id": "itemId|collectionId|groupId|policyId|memberId|secretId|projectId|serviceAccountId", "resource_type": "object", "source_event_id": "date"},
