...
const (
	...
	defaultHealthPath      = "/services/data/v60.0"
	defaultBaseURLTemplate = "https://${config.instance_url}"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
	familyAssets           = "assets"
...
var templateKeys = []string{"client_id", "client_secret", "instance_url"}
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://${config.instance_url}/oauth/token",
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "salesforce_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "salesforce"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/records",
				URNKind:          "salesforce_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "salesforce"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "salesforce_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "salesforce"},
			},
		},
	})
	if err != nil {
