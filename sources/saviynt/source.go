		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "saviynt"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "saviynt_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "saviynt"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "saviynt_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "saviynt"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "saviynt_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "saviynt"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "saviynt_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "saviynt"},
			},
		},
	})
	if err != nil {
