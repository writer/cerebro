		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "cerbos_cloud"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "cerbos_cloud_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "cerbos_cloud"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "cerbos_cloud_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "cerbos_cloud"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "cerbos_cloud_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "cerbos_cloud"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "cerbos_cloud_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "cerbos_cloud"},
			},
		},
	})
	if err != nil {
