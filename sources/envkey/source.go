		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "envkey"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "envkey_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "envkey"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "envkey_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "envkey"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "envkey_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "envkey"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "envkey_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "envkey"},
			},
		},
	})
	if err != nil {
