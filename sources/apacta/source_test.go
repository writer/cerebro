...
func TestSourceCheckAndRead(t *testing.T) {
	...
	defer server.Close()
	cfgValues := map[string]string{"tenant_id": "tenant", "base_url": server.URL, "family": defaultFamily, "api_token": "test-token", "contact_id": "test-contact_id", "offer_id": "test-offer_id", "project_id": "test-project_id", "user_id": "test-user_id"}
