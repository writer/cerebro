...
const (
	sourceID               = "clever_cloud"
	defaultFamily          = familyEmail
	defaultHealthPath      = "/github/emails"
	defaultBaseURLTemplate = "https://api.clever-cloud.com/v2"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyEmail            = "email"
	familyToken            = "token"
	familyNetworkgroup     = "networkgroup"
	familyDeployment       = "deployment"
)

var templateKeys = []string{"id", "ownerid", "token"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "email", "source_system": "clever_cloud"},
			},
			{
				Name:             familyToken,
				Path:             "/self/tokens",
				URNKind:          "clever_token",
				IDKeys:           []string{"consumer", "secret_id", "id", "name", "key", "sid"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "consumer", "name": "consumer", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "secret_created_at": "created_at|created|date_created", "secret_id": "consumer", "secret_last_rotated_at": "secret_last_rotated_at|last_rotated_at|last_rotated|rotated_at", "secret_name": "consumer", "secret_rotation_enabled": "secret_rotation_enabled|rotation_enabled|auto_rotate", "secret_status": "secret_status|status|state", "secret_type": "token", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "token", "source_system": "clever_cloud"},
			},
			{
				Name:             familyNetworkgroup,
				Path:             "/v4/networkgroups/organisations/${config.ownerid}/networkgroups",
				URNKind:          "clever_networkgroup",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "networkgroup", "source_system": "clever_cloud"},
			},
			{
				Name:             familyDeployment,
				Path:             "/organisations/${config.id}/deployments",
				URNKind:          "clever_deployment",
				IDKeys:           []string{"id", "action", "deployment_id", "name", "url", "uid"},
				ListKeys:         []string{"{app_id}"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"deployment_branch": "branch|ref|git_branch|head_branch", "deployment_commit_sha": "commit_sha|commit|sha|revision|git_sha", "deployment_created_at": "created_at|created|date_created", "deployment_environment": "action", "deployment_id": "id", "deployment_name": "action", "deployment_status": "state", "deployment_updated_at": "updated_at|updated|last_modified", "deployment_url": "url|deployment_url|endpoint|domain", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "name": "action", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "deployment", "schema": "deployment", "source_system": "clever_cloud"},
			},
		},
	})
	if err != nil {
