package zscaler_private_access
...
const (
	sourceID               = "zscaler_private_access"
		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "zscaler_private_access_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "zscaler_private_access"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "zscaler_private_access_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "zscaler_private_access"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "zscaler_private_access_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "zscaler_private_access"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "zscaler_private_access_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "zscaler_private_access"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "zscaler_private_access_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "zscaler_private_access"},
			},
		},
	})
	if err != nil {
