	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "permit_io"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "permit_io_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "permit_io"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "permit_io_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "permit_io"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "permit_io_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "permit_io"},
			},
		},
	})
	if err != nil {
