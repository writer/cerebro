package google_secops_chronicle
...
const (
	sourceID               = "google_secops_chronicle"
	defaultFamily          = familyAuditEvents
	defaultHealthPath      = "/v2/detect/rules"
	defaultBaseURLTemplate = "https://backstory.googleapis.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
...
var templateKeys = []string{"private_key"}
		...
		Families: []jsonapi.Family{
			{
				...
				Path:             "/v1/events",
				URNKind:          "google_secops_chronicle_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "google_secops_chronicle"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/detections",
				URNKind:          "google_secops_chronicle_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "google_secops_chronicle"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/assets",
				URNKind:          "google_secops_chronicle_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "google_secops_chronicle"},
			},
		},
	})
	if err != nil {
