		...
		Families: []jsonapi.Family{
			{
				...
				Config: jsonapi.FamilyConfig{
					...
					ConfigQuery:      map[string]string{"order_by": "order_by", "search": "search", "simple": "simple"},
					EncodeURNID:      true,
					ResourceURNKind:  "runtime_repositories",
				},
			...
			},
			{
				...
				Config: jsonapi.FamilyConfig{
					AuthModel:        "none",
					ConfigAttributes: map[string]string{"tenant_id": "tenant_id"},
					ConfigQuery:      map[string]string{"username": "username"},
					EncodeURNID:      true,
