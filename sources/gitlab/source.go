...
const (
	...
	defaultHealthPath      = "/v4/user"
	defaultBaseURLTemplate = "https://gitlab.com/api"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "gitlab"},
			},
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "gitlab_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "gitlab"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "gitlab_audit_events",
