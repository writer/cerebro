		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "appfolio"},
			},
			{
				Name:             familyAccounts,
				Path:             "/v1/accounts",
				URNKind:          "appfolio_accounts",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "accounts", "source_system": "appfolio"},
			},
			{
				Name:             familyRecords,
				Path:             "/v1/records",
				URNKind:          "appfolio_records",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "records", "source_system": "appfolio"},
			},
			{
				Name:             familyPolicies,
				Path:             "/v1/policies",
				URNKind:          "appfolio_policies",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "policies", "source_system": "appfolio"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "appfolio_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "appfolio"},
			},
		},
	})
	if err != nil {
