		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "britive"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "britive_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "britive"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "britive_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "britive"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "britive_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "britive"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "britive_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "britive"},
			},
		},
	})
	if err != nil {
