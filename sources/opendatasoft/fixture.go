...
// NewFixture constructs the deterministic opendatasoft source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"aggregate", "attachment", "dataset", "datasets_aggregate", "datasets_facet", "facet", "metadata_template", "page", "record", "resource", "resource_2", "reuses"} {
