...
const (
	sourceID               = "lastpass_business"
	defaultFamily          = familyUsers
	defaultHealthPath      = "/enterpriseapi.php"
	defaultBaseURLTemplate = "https://lastpass.com"
	tokenHeader            = ""
	tokenScheme            = "Token"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "lastpass_business_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "lastpass_business"},
			},
			{
				Name:             familySecrets,
				Path:             "/v1/secrets",
				URNKind:          "lastpass_business_secrets",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "secrets", "source_system": "lastpass_business"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "lastpass_business_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "lastpass_business"},
			},
		},
	})
	if err != nil {
