...
// NewFixture constructs the deterministic aws_bedrock source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"custom_models", "foundation_models", "guardrails", "model_customization_jobs", "provisioned_model_throughputs"} {
