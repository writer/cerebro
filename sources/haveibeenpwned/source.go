	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				URNKind:          "haveibeenpwned_affected_accounts",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "affected_accounts", "source_system": "haveibeenpwned"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/audit-events",
				URNKind:          "haveibeenpwned_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "haveibeenpwned"},
			},
		},
	})
	if err != nil {
