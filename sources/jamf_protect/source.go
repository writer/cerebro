		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "jamf_protect"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "jamf_protect_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "jamf_protect"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "jamf_protect_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "jamf_protect"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "jamf_protect_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "jamf_protect"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "jamf_protect_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "jamf_protect"},
			},
		},
	})
	if err != nil {
