...
const (
	sourceID               = "mongodb_atlas"
	defaultFamily          = familyAssets
	defaultHealthPath      = "/v2/groups"
	defaultBaseURLTemplate = "https://cloud.mongodb.com/api/atlas"
	tokenHeader            = ""
	tokenScheme            = "Basic"
	familyAssets           = "assets"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "mongodb_atlas"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "mongodb_atlas_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "mongodb_atlas"},
			},
			{
				Name:             familyVulnerabilities,
				Path:             "/v1/vulnerabilities",
				URNKind:          "mongodb_atlas_vulnerabilities",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "vulnerabilities", "source_system": "mongodb_atlas"},
			},
		},
	})
	if err != nil {
