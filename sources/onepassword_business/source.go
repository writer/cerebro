...
const (
	sourceID               = "onepassword_business"
	defaultFamily          = familyUsers
	defaultHealthPath      = "/v1/vaults"
	defaultBaseURLTemplate = "https://api.1password.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "onepassword_business_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "onepassword_business"},
			},
			{
				Name:             familySecrets,
				Path:             "/v1/secrets",
				URNKind:          "onepassword_business_secrets",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "secrets", "source_system": "onepassword_business"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "onepassword_business_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "onepassword_business"},
			},
		},
	})
	if err != nil {
