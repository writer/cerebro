...
const (
	...
	defaultHealthPath          = "/v1/resources"
	defaultBaseURLTemplate     = "https://api.vanta.com"
	tokenHeader                = ""
	tokenScheme                = "Bearer"
	oauthTokenURLTemplate      = "https://api.vanta.com/oauth/token" // #nosec G101 -- token endpoint URL template, not credential material.
	oauthScopeSeparator        = " "
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://api.vanta.com/oauth/token",
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "vanta"},
			},
			{
				Name:             familyControls,
				Path:             "/v1/controls",
				URNKind:          "vanta_controls",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "controls", "source_system": "vanta"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/findings",
				URNKind:          "vanta_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "vanta"},
			},
		},
	})
	if err != nil {
