...
const (
	...
	defaultBaseURLTemplate = "https://api.linear.app"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "linear"},
			},
			{
				Name:             familyProjects,
				Path:             "/v1/projects",
				URNKind:          "linear_projects",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "linear"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "linear_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "linear"},
			},
		},
	})
	if err != nil {
