...
const (
	sourceID                   = "cyberark_identity"
	defaultFamily              = familyUsers
	defaultHealthPath          = "/Security/Whoami"
		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "cyberark_identity_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "cyberark_identity"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "cyberark_identity_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "cyberark_identity"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "cyberark_identity_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "cyberark_identity"},
			},
		},
	})
	if err != nil {
