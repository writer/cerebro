...
// NewFixture constructs the deterministic microsoft_defender_for_endpoint source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"endpoint_devices", "findings", "vulnerabilities"} {
