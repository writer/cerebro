...
const (
	...
	defaultBaseURLTemplate = "https://api.stripe.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
	familyAssets           = "assets"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "stripe"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/records",
				URNKind:          "stripe_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "stripe"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "stripe_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "stripe"},
			},
		},
	})
	if err != nil {
