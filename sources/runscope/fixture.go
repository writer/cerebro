...
// NewFixture constructs the deterministic runscope source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"agent", "bucket", "buckets_test", "environment", "integration", "metric", "people", "test"} {
