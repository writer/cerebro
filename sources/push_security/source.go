		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "push_security"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "push_security_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "push_security"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "push_security_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "push_security"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "push_security_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "push_security"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "push_security_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "push_security"},
			},
		},
	})
	if err != nil {
