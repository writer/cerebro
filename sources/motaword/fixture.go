...
// NewFixture constructs the deterministic motaword source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"activities_comment", "activity", "blog", "comment", "corporate_user", "corporate_user_group", "corporates_user", "permission", "projects_activity", "user", "user_group", "user_group_2"} {
