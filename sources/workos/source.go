...
const (
	...
	defaultBaseURLTemplate = "https://api.workos.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
	familyGroups           = "groups"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "workos"},
			},
			{
				Name:             familyGroups,
				Path:             "/groups",
				URNKind:          "workos_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "workos"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/events",
				URNKind:          "workos_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "workos"},
			},
		},
	})
	if err != nil {
