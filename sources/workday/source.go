...
const (
	...
	defaultHealthPath          = "/ccx/api/v1/${config.tenant}/workers"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "workday"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/organizations",
				URNKind:          "workday_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "workday"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "workday_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "workday"},
			},
		},
	})
	if err != nil {
