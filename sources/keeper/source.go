...
const (
	...
	defaultHealthPath      = "/rest/sm/v1/secrets"
	defaultBaseURLTemplate = "https://keepersecurity.com/api"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "keeper"},
			},
			{
				Name:             familySecrets,
				Path:             "/v1/secrets",
				URNKind:          "keeper_secrets",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "secrets", "source_system": "keeper"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "keeper_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "keeper"},
			},
		},
	})
	if err != nil {
