...
const (
	...
	defaultBaseURLTemplate = "https://api.buildkite.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "pipelines", "source_system": "buildkite"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/findings",
				URNKind:          "buildkite_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "buildkite"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "buildkite_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "buildkite"},
			},
		},
	})
	if err != nil {
