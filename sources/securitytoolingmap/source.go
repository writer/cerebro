		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				Attributes: map[string]string{
					...
					"d3fend_tactics":          "d3fend_tactics",
					"d3fend_technique":        "d3fend_technique",
					"d3fend_techniques":       "d3fend_techniques",
					"d3fend_artifact":         "d3fend_artifact",
					"d3fend_artifacts":        "d3fend_artifacts",
					"defend_tactic":           "defend_tactic",
					"defend_tactics":          "defend_tactics",
					"defend_technique":        "defend_technique",
					"defend_techniques":       "defend_techniques",
					"defend_artifact":         "defend_artifact",
					"defend_artifacts":        "defend_artifacts",
					"mitre_defend_tactic":     "mitre_defend_tactic",
					"mitre_defend_tactics":    "mitre_defend_tactics",
					"mitre_defend_technique":  "mitre_defend_technique",
					"mitre_defend_techniques": "mitre_defend_techniques",
					"mitre_defend_artifact":   "mitre_defend_artifact",
					"mitre_defend_artifacts":  "mitre_defend_artifacts",
