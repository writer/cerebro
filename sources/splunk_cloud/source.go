...
const (
	sourceID               = "splunk_cloud"
	defaultFamily          = familyAuditEvents
	defaultHealthPath      = "/services/server/info"
	defaultBaseURLTemplate = "https://${config.stack_url}"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
...
var templateKeys = []string{"token", "stack_url"}
		...
		Families: []jsonapi.Family{
			{
				...
				Path:             "/v1/events",
				URNKind:          "splunk_cloud_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "splunk_cloud"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/detections",
				URNKind:          "splunk_cloud_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "splunk_cloud"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/assets",
				URNKind:          "splunk_cloud_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "splunk_cloud"},
			},
		},
	})
	if err != nil {
