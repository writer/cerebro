...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			{Name: "channel", Path: "/conversations.list", URNKind: "slack_channel", IDKeys: []string{"id", "channel_id"}, TimestampKeys: []string{"updated", "created"}, Attributes: map[string]string{"channel_id": "id|channel_id", "team_id": "context_team_id|shared_team_ids", "name": "name", "is_private": "is_private", "is_archived": "is_archived", "creator": "creator", "num_members": "num_members"}, StaticAttributes: map[string]string{"source_product": "slack"}},
