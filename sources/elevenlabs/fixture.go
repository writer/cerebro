...
// NewFixture constructs the deterministic elevenlabs source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"auth_connections", "model_catalog", "service_account_api_keys", "service_accounts", "voices", "webhooks"} {
