...
const (
	sourceID               = "secureframe"
	defaultFamily          = familyUsers
	defaultHealthPath      = "/v1/people"
	defaultBaseURLTemplate = "https://api.secureframe.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "secureframe"},
			},
			{
				Name:             familyControls,
				Path:             "/v1/controls",
				URNKind:          "secureframe_controls",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "controls", "source_system": "secureframe"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/findings",
				URNKind:          "secureframe_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "secureframe"},
			},
		},
	})
	if err != nil {
