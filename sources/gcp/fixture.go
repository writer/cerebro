...
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{familyAudit, familyGroup, familyGroupMember, familyResourceExposure, familyRoleAssign, familySAImpersonation, familyServiceAcct, familySAKey} {
