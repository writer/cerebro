		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "dashlane_business_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "dashlane_business"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "dashlane_business_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "dashlane_business"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "dashlane_business_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "dashlane_business"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "dashlane_business_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "dashlane_business"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "dashlane_business_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "dashlane_business"},
			},
		},
	})
	if err != nil {
