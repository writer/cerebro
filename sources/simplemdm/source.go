		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "simplemdm"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "simplemdm_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "simplemdm"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "simplemdm_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "simplemdm"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "simplemdm_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "simplemdm"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "simplemdm_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "simplemdm"},
			},
		},
	})
	if err != nil {
