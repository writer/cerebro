package hid_workforce_identity
...
const (
	sourceID               = "hid_workforce_identity"
		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "hid_workforce_identity_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "hid_workforce_identity"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "hid_workforce_identity_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "hid_workforce_identity"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "hid_workforce_identity_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "hid_workforce_identity"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "hid_workforce_identity_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "hid_workforce_identity"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "hid_workforce_identity_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "hid_workforce_identity"},
			},
		},
	})
	if err != nil {
