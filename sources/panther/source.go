...
const (
	...
	defaultHealthPath      = "/public/graphql"
...
var templateKeys = []string{"token", "instance_url"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "panther"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/detections",
				URNKind:          "panther_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "panther"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/assets",
				URNKind:          "panther_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "panther"},
			},
		},
	})
	if err != nil {
