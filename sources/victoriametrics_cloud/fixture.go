...
// NewFixture constructs the deterministic victoriametrics_cloud source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"accounts", "audit_events", "policies", "records", "users"} {
