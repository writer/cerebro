package manageengine_endpoint_central
...
const (
	sourceID               = "manageengine_endpoint_central"
		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "manageengine_endpoint_central_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "manageengine_endpoint_central"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "manageengine_endpoint_central_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "manageengine_endpoint_central"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "manageengine_endpoint_central_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "manageengine_endpoint_central"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "manageengine_endpoint_central_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "manageengine_endpoint_central"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "manageengine_endpoint_central_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "manageengine_endpoint_central"},
			},
		},
	})
	if err != nil {
