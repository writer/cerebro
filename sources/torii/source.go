		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "torii"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "torii_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "torii"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "torii"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "torii_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "torii"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "torii_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "torii"},
			},
		},
	})
	if err != nil {
