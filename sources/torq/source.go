...
const (
	...
	defaultHealthPath          = "/v1/users/me"
	defaultBaseURLTemplate     = "https://api.torq.io"
	tokenHeader                = ""
	tokenScheme                = "Bearer"
	oauthTokenURLTemplate      = "https://api.torq.io/oauth/token" // #nosec G101 -- token endpoint URL template, not credential material.
	oauthScopeSeparator        = " "
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://api.torq.io/oauth/token",
		Families: []jsonapi.Family{
			{
				Name:             familyAuditEvents,
				Path:             "/v1/events",
				URNKind:          "torq_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "torq"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/cases",
				URNKind:          "torq_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "torq"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "torq"},
			},
		},
	})
	if err != nil {
