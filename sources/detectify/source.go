...
const (
	sourceID               = "detectify"
	defaultFamily          = familyFindings
	defaultHealthPath      = "/v2/status"
	defaultBaseURLTemplate = "https://api.detectify.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyFindings         = "findings"
	familyAssets           = "assets"
	familyScanProfiles     = "scan_profiles"
)
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "detectify"},
			},
			{
				Name:             familyAssets,
				Path:             "/v2/assets",
				URNKind:          "detectify_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "detectify"},
			},
			{
				Name:             familyScanProfiles,
				Path:             "/v2/scanprofiles",
				URNKind:          "detectify_scan_profiles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "scan_profiles", "source_system": "detectify"},
			},
		},
	})
	if err != nil {
