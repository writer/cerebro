...
// NewFixture constructs the deterministic xtrf_eu source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"active", "all", "customer", "customers_id", "id", "id_2", "invoices_id", "persons_id", "projects_id", "providers_id", "quotes_id", "user"} {
