...
// NewFixture constructs the deterministic cloudflare source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"access_application", "access_group", "account", "account_ruleset", "audit_log", "dns_record", "gateway_rule", "load_balancer", "load_balancer_pool", "member", "role", "worker_script", "zone", "zone_access_application", "zone_access_group", "zone_ruleset"} {
