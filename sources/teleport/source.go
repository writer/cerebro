...
const (
	...
	defaultHealthPath      = "/v1/webapi/ping"
	defaultBaseURLTemplate = "https://${config.cluster_url}"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
	familyGroups           = "groups"
...
var templateKeys = []string{"token", "cluster_url"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "teleport"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "teleport_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "teleport"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "teleport_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "teleport"},
			},
		},
	})
	if err != nil {
