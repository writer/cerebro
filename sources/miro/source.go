...
const (
	...
	defaultBaseURLTemplate = "https://api.miro.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://api.miro.com/oauth/token",
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "miro"},
			},
			{
				Name:             familyProjects,
				Path:             "/v1/projects",
				URNKind:          "miro_projects",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "miro"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "miro_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "miro"},
			},
		},
	})
	if err != nil {
