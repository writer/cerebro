...
// NewFixture constructs the deterministic jumpseller source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"checkout_custom_fields_json", "countries_json", "custom_fields_json", "customer_categories_json", "customers_json", "fulfillments_json", "hooks_json", "jsapps_json", "orders_json", "pages_json", "payment_methods_json", "products_json"} {
