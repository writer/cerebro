		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "descope"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "descope_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "descope"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "descope_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "descope"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "descope_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "descope"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "descope_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "descope"},
			},
		},
	})
	if err != nil {
