...
const (
	sourceID               = "mistral"
	defaultFamily          = familyWorkspaces
	defaultHealthPath      = "/v1/models"
	defaultBaseURLTemplate = "https://api.mistral.ai"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "workspaces", "source_system": "mistral"},
			},
			{
				Name:             familyApiKeys,
				Path:             "/v1/organization/api-keys",
				URNKind:          "mistral_api_keys",
				...
				StaticAttributes: map[string]string{"record_class": "secret", "schema": "api_keys", "source_system": "mistral"},
			},
			{
				Name:             familyAuditLogs,
				Path:             "/v1/organization/audit-logs",
				URNKind:          "mistral_audit_logs",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_logs", "source_system": "mistral"},
			},
			{
				Name:             familyUsageReports,
				Path:             "/v1/organization/usage",
				URNKind:          "mistral_usage_reports",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "usage_reports", "source_system": "mistral"},
			},
		},
	})
	if err != nil {
