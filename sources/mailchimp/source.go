...
const (
	sourceID               = "mailchimp"
	defaultFamily          = familyLists
	defaultHealthPath      = "/ping"
	defaultBaseURLTemplate = "https://${config.dc}.api.mailchimp.com/3.0"
	tokenHeader            = ""
	tokenScheme            = "Token"
	familyLists            = "lists"
...
var templateKeys = []string{"api_key", "dc"}
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				Path:             "/activity-feed",
				URNKind:          "mailchimp_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "mailchimp"},
			},
		},
	})
	if err != nil {
