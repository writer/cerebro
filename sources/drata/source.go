...
const (
	...
	defaultHealthPath      = "/public/users"
	defaultBaseURLTemplate = "https://public-api.drata.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "drata"},
			},
			{
				Name:             familyControls,
				Path:             "/v1/controls",
				URNKind:          "drata_controls",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "controls", "source_system": "drata"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/findings",
				URNKind:          "drata_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "drata"},
			},
		},
	})
	if err != nil {
