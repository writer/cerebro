...
// NewFixture constructs the deterministic drchrono source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"allergy", "amendment", "appointment", "appointment_profile", "appointment_template", "care_team_member", "comm_log", "implantable_device", "patient_payment_log", "patient_risk_assessment", "user", "user_group"} {
