...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			duoOffsetInventoryFamily(jsonapi.Family{Name: "application", Path: "/admin/v3/integrations", URNKind: "duo_application", IDKeys: []string{"integration_key", "ikey", "key"}, ListKeys: []string{"response"}, TimestampKeys: []string{"created"}, Config: jsonapi.FamilyConfig{AuthModel: "duo_hmac_v5"}, Attributes: map[string]string{"resource_id": "integration_key|ikey|key", "resource_name": "name", "resource_type": "type|integration_type", "integration_key": "integration_key|ikey|key", "name": "name", "type": "type|integration_type"}, StaticAttributes: map[string]string{"source_product": "duo"}}),
