...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			duoOffsetInventoryFamily(jsonapi.Family{Name: "user", Path: "/admin/v1/users", URNKind: "duo_user", IDKeys: []string{"user_id"}, ListKeys: []string{"response"}, TimestampKeys: []string{"created", "last_login"}, Attributes: map[string]string{"user_id": "user_id", "username": "username", "email": "email", "realname": "realname", "status": "status", "last_login_at": "last_login", "is_enrolled": "is_enrolled", "lockout_reason": "lockout_reason", "last_directory_sync": "last_directory_sync"}, StaticAttributes: map[string]string{"source_product": "duo"}}),
			duoOffsetInventoryFamily(jsonapi.Family{Name: "group", Path: "/admin/v1/groups", URNKind: "duo_group", IDKeys: []string{"group_id"}, ListKeys: []string{"response"}, TimestampKeys: []string{"created"}, Attributes: map[string]string{"group_id": "group_id", "name": "name", "description": "desc|description", "status": "status"}, StaticAttributes: map[string]string{"source_product": "duo"}}),
			duoOffsetInventoryFamily(jsonapi.Family{Name: "administrator", Path: "/admin/v1/admins", URNKind: "duo_administrator", IDKeys: []string{"admin_id", "email", "name"}, ListKeys: []string{"response"}, TimestampKeys: []string{"created", "last_login"}, Attributes: map[string]string{"admin_id": "admin_id", "user_id": "admin_id", "name": "name", "email": "email", "status": "status", "role": "role", "last_login_at": "last_login", "created_at": "created"}, StaticAttributes: map[string]string{"source_product": "duo", "resource_type": "administrator"}}),
			duoOffsetInventoryFamily(jsonapi.Family{Name: "endpoint", Path: "/admin/v1/endpoints", URNKind: "duo_endpoint", IDKeys: []string{"endpoint_id", "epkey"}, ListKeys: []string{"response"}, TimestampKeys: []string{"last_seen", "created"}, Attributes: map[string]string{"endpoint_id": "endpoint_id|epkey", "hostname": "hostname", "os": "os", "os_version": "os_version", "browser": "browser", "disk_encryption_status": "disk_encryption_status", "last_seen_at": "last_seen"}, StaticAttributes: map[string]string{"source_product": "duo"}}),
			duoOffsetInventoryFamily(jsonapi.Family{Name: "phone", Path: "/admin/v1/phones", URNKind: "duo_phone", IDKeys: []string{"phone_id"}, ListKeys: []string{"response"}, TimestampKeys: []string{"last_seen", "created"}, Attributes: map[string]string{"phone_id": "phone_id", "name": "name", "number": "number", "platform": "platform", "model": "model", "capabilities": "capabilities", "activated": "activated", "encrypted": "encrypted", "screenlock": "screenlock", "tampered": "tampered", "last_seen_at": "last_seen", "user_id": "user_id"}, StaticAttributes: map[string]string{"source_product": "duo"}}),
			duoOffsetInventoryFamily(jsonapi.Family{Name: "token", Path: "/admin/v1/tokens", URNKind: "duo_token", IDKeys: []string{"token_id"}, ListKeys: []string{"response"}, TimestampKeys: []string{"last_seen", "created"}, Attributes: map[string]string{"token_id": "token_id", "serial": "serial", "type": "type", "totp_step": "totp_step", "last_seen_at": "last_seen", "user_id": "user_id"}, StaticAttributes: map[string]string{"source_product": "duo"}}),
			duoOffsetInventoryFamily(jsonapi.Family{
			...
			duoOffsetInventoryFamily(jsonapi.Family{Name: "role", Path: "/admin/v1/admin_roles", URNKind: "duo_role", IDKeys: []string{"role_id", "name"}, ListKeys: []string{"response"}, Attributes: map[string]string{"policy_id": "role_id|name", "policy_name": "name", "description": "desc|description"}, StaticAttributes: map[string]string{"source_product": "duo", "resource_type": "administrator_role", "policy_type": "administrator_role"}}),
			duoOffsetInventoryFamily(jsonapi.Family{Name: "application", Path: "/admin/v3/integrations", FamilyRequest: jsonapi.FamilyRequest{AuthModel: "duo_hmac_v5"}, URNKind: "duo_application", IDKeys: []string{"integration_key", "ikey", "key"}, ListKeys: []string{"response"}, TimestampKeys: []string{"created"}, Attributes: map[string]string{"resource_id": "integration_key|ikey|key", "resource_name": "name", "resource_type": "type|integration_type", "integration_key": "integration_key|ikey|key", "name": "name", "type": "type|integration_type"}, StaticAttributes: map[string]string{"source_product": "duo"}}),
...
func duoOffsetInventoryFamily(family jsonapi.Family) jsonapi.Family {
