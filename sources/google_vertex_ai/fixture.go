...
// NewFixture constructs the deterministic google_vertex_ai source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"batch_prediction_jobs", "custom_jobs", "endpoints", "indexes", "models", "reasoning_engines"} {
