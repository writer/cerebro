...
// NewFixture constructs the deterministic clearblade source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"admin_audit", "audit", "connection", "deployment", "listindexe", "platform_system", "session_user", "system", "timer", "topic", "trigger", "user"} {
