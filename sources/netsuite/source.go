...
const (
	...
	defaultHealthPath      = "/services/rest/record/v1/metadata-catalog"
	defaultBaseURLTemplate = "https://${config.account}.suitetalk.api.netsuite.com"
	tokenHeader            = ""
	tokenScheme            = "Signature"
	familyUsers            = "users"
	familyAssets           = "assets"
	familyAuditEvents      = "audit_events"
)

var templateKeys = []string{"access_key", "secret_key", "account"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "netsuite"},
			},
			{
				Name:             familyAssets,
				Path:             "/v1/records",
				URNKind:          "netsuite_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "assets", "source_system": "netsuite"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "netsuite_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "netsuite"},
			},
		},
	})
	if err != nil {
