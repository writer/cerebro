...
const (
	...
	defaultHealthPath      = "/api/json"
	defaultBaseURLTemplate = "https://${config.jenkins_url}"
	tokenHeader            = ""
	tokenScheme            = "Basic"
...
var templateKeys = []string{"password", "username", "jenkins_url"}
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "pipelines", "source_system": "jenkins"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/findings",
				URNKind:          "jenkins_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "jenkins"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "jenkins_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "jenkins"},
			},
		},
	})
	if err != nil {
