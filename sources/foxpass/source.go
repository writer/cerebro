		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "foxpass"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "foxpass_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "foxpass"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "foxpass_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "foxpass"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "foxpass_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "foxpass"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "foxpass_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "foxpass"},
			},
		},
	})
	if err != nil {
