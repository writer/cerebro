		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "nordlayer"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "nordlayer_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "nordlayer"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "nordlayer_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "nordlayer"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "nordlayer_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "nordlayer"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "nordlayer_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "nordlayer"},
			},
		},
	})
	if err != nil {
