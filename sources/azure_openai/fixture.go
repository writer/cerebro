...
// NewFixture constructs the deterministic azure_openai source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"deployments", "model_catalog", "private_endpoint_connections", "rai_blocklists", "rai_policies"} {
