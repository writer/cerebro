		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "alert", "schema": "alerts", "source_system": "cast_ai"},
			},
			{
				Name:             familyIncidents,
				Path:             "/v1/incidents",
				URNKind:          "cast_ai_incidents",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "incidents", "source_system": "cast_ai"},
			},
			{
				Name:             familyMonitors,
				Path:             "/v1/monitors",
				URNKind:          "cast_ai_monitors",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "monitors", "source_system": "cast_ai"},
			},
			{
				Name:             familyDashboards,
				Path:             "/v1/dashboards",
				URNKind:          "cast_ai_dashboards",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "dashboards", "source_system": "cast_ai"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "cast_ai_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "cast_ai"},
			},
		},
	})
	if err != nil {
