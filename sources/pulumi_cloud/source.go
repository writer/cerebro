...
const (
	sourceID               = "pulumi_cloud"
	defaultFamily          = familyRepositories
	defaultHealthPath      = "/user"
	defaultBaseURLTemplate = "https://api.pulumi.com/api"
	tokenHeader            = ""
	tokenScheme            = "Token"
		...
		Families: []jsonapi.Family{
			{
				...
				URNKind:          "pulumi_cloud_repositories",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "pulumi_cloud"},
			},
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "pulumi_cloud_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "pulumi_cloud"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "pulumi_cloud_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "pulumi_cloud"},
			},
		},
	})
	if err != nil {
