...
// NewFixture constructs the deterministic splunk_observability source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"alerts", "audit_events", "dashboards", "incidents", "monitors"} {
