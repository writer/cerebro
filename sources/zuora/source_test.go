...
func TestSourceCheckAndReadFamilies(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantAttributes: map[string]string{"name": "Subscription Revenue", "observed_at": "2026-06-02T00:00:00Z", "record_class": "asset", "resource_type": "accounting_code", "status": "Active"},
		...
		},
		{
			...
			wantAttributes: map[string]string{"name": "Jun 2026", "observed_at": "2026-06-02T00:00:00Z", "record_class": "asset", "resource_type": "accounting_period", "status": "Open"},
		...
		},
		{
			...
			wantAttributes: map[string]string{"alert_id": "New Subscription Created-3", "alert_name": "New Subscription Created", "alert_source": "https://callback.example.test/zuora", "alert_status": "405", "observed_at": "2026-06-01T03:33:51", "provider_id": "New Subscription Created-3", "resource_id": "New Subscription Created-3", "resource_name": "New Subscription Created", "source_event_id": "New Subscription Created-3"},
		...
		{
			name:   "inactive notification definition",
			family: familyNotificationDefinition,
			path:   "/notifications/notification-definitions",
			kind:   "zuora.notification_definition",
			response: map[string]any{"data": []map[string]any{{
				"id":            "6e569e1e05f040eda51a927b140c0ac5",
				"createdOn":     "2026-06-01T07:36:19.798Z",
				"updatedOn":     "2026-06-02T07:36:19.798Z",
				"eventTypeName": "AccountEdit",
				"name":          "Account Edit SMS",
				"description":   "SMS when an account is edited",
				"active":        false,
			}}},
			wantAttributes: map[string]string{"alert_id": "6e569e1e05f040eda51a927b140c0ac5", "alert_name": "Account Edit SMS", "alert_status": "inactive", "observed_at": "2026-06-02T07:36:19.798Z", "resource_type": "notification_definition"},
			wantPayloadKey: "active",
			wantOccurredAt: "2026-06-02T07:36:19.798Z",
		},
		{
			name:   "hosted page",
