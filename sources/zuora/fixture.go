...
// NewFixture constructs the deterministic zuora source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"account", "accounting_code", "accounting_period", "callout", "email", "email_template", "event_trigger", "hostedpage", "notification_definition", "product", "revenue_event", "revenue_schedule"} {
