	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				TimestampKeys:    []string{"createTime", "observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"alert_description": "description|summary|message|body|notification", "alert_fired_at": "fired_at|triggered_at|createTime|created_at|occurred_at|timestamp", "alert_id": "_record_id", "alert_name": "notification|requestUrl|attemptedNum", "alert_resolved_at": "resolved_at|closed_at|acknowledged_at", "alert_severity": "severity|alert_severity|risk_level", "alert_source": "requestUrl|source|alert_source|monitor|check", "alert_status": "responseCode|status|result|attemptedNum", "alert_type": "eventCategory|alert_type|type|category|kind", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "_record_id", "name": "notification|requestUrl|attemptedNum", "observed_at": "observed_at|createTime|updated_at|last_seen_at", "provider_id": "_record_id", "resource_id": "_record_id", "resource_name": "notification|requestUrl|attemptedNum", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|_record_id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				Config:           jsonapi.FamilyConfig{IDTemplate: "${notification}-${attemptedNum}", EncodeURNID: true, ResourceURNKind: "zuora_callout"},
			...
			},
			{
				...
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "pageId", "name": "pageId", "observed_at": "observed_at|updated_at|last_seen_at", "provider_id": "pageId", "resource_id": "pageId", "resource_name": "pageId", "resource_type": "hostedpage", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|pageId|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				Config:           jsonapi.FamilyConfig{ResourceURNKind: "zuora_hostedpage"},
			...
			},
			{
				...
				TimestampKeys:    []string{"updatedOn", "createdOn", "observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"created_at": "createdOn|created_at|created|profile.created_at", "department": "department|profile.department", "display_name": "display_name|name|profile.display_name|profile.name", "domain": "domain|tenant_domain|organization_domain", "email": "email|primary_email|profile.email", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "job_title": "job_title|title|profile.title", "last_login_at": "last_login_at|last_login|last_seen_at", "login": "login|username|email|profile.login", "manager": "manager|profile.manager", "name": "name", "observed_at": "observed_at|updatedOn|createdOn|updated_at|last_seen_at", "primary_email": "primary_email|email|profile.email", "provider_id": "id", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "status": "status|state|lifecycle_state", "tenant_id": "tenant_id|metadata.tenant_id", "user_id": "user_id|id|uid"},
				StaticAttributes: map[string]string{"record_class": "asset", "resource_type": "accounting_period", "schema": "accounting_period", "source_system": "zuora"},
			},
			{
				Name:             familyEmail,
				Path:             "/v1/notification-history/email",
				URNKind:          "zuora_email",
				IDKeys:           []string{"accountId", "sendTime", "subject", "user_id", "id", "email", "primary_email", "login"},
				PageSizeParams:   []string{"pageSize"},
				ListKeys:         []string{"emailHistories"},
				TimestampKeys:    []string{"sendTime", "observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"created_at": "sendTime|created_at|created|profile.created_at", "department": "department|profile.department", "display_name": "display_name|subject|name|profile.display_name|profile.name", "domain": "domain|tenant_domain|organization_domain", "email": "toEmail|email|primary_email|profile.email|bcc", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "_record_id", "job_title": "job_title|title|profile.title", "last_login_at": "last_login_at|last_login|last_seen_at", "login": "login|username|email|profile.login", "manager": "manager|profile.manager", "name": "subject", "observed_at": "observed_at|sendTime|updated_at|last_seen_at", "primary_email": "toEmail|primary_email|email|profile.email", "provider_id": "_record_id", "resource_id": "resource_id|_record_id|accountId|metadata.resource_id", "resource_name": "subject|notification|name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|_record_id|accountId|metadata.event_id", "status": "result|status|state|lifecycle_state", "tenant_id": "tenant_id|metadata.tenant_id", "user_id": "_record_id|accountId|user_id|id|uid"},
				Config:           jsonapi.FamilyConfig{IDTemplate: "${accountId}-${sendTime}-${eventCategory}-${notification}", EncodeURNID: true, IdentityKeys: []string{"sendTime", "subject", "toEmail"}, ResourceURNKind: "zuora_email"},
				StaticAttributes: map[string]string{"record_class": "audit_event", "resource_type": "email_history", "schema": "email", "source_system": "zuora"},
			},
			{
				...
				Config:           jsonapi.FamilyConfig{BoolStatusAttributes: map[string]string{"status": "active"}, ResourceURNKind: "zuora_email_template"},
				StaticAttributes: map[string]string{"record_class": "asset", "resource_type": "email_template", "schema": "email_template", "source_system": "zuora"},
			},
			{
				...
				ListKeys:         []string{"data"},
				TimestampKeys:    []string{"updatedOn", "createdOn", "observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"alert_description": "description|summary|message|body", "alert_fired_at": "fired_at|triggered_at|createdOn|created_at|occurred_at|timestamp", "alert_id": "id", "alert_name": "name", "alert_resolved_at": "resolved_at|closed_at|acknowledged_at", "alert_severity": "severity|alert_severity|risk_level", "alert_source": "source|alert_source|monitor|check", "alert_status": "status|state|lifecycleStatus|lifecycle_state", "alert_type": "alert_type|type|category|kind", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "name": "name", "observed_at": "observed_at|updatedOn|createdOn|updated_at|last_seen_at", "provider_id": "id", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				Config:           jsonapi.FamilyConfig{BoolStatusAttributes: map[string]string{"alert_status": "active"}, ResourceURNKind: "zuora_notification_definition"},
				StaticAttributes: map[string]string{"record_class": "alert", "resource_type": "notification_definition", "schema": "notification_definition", "source_system": "zuora"},
			},
			{
				...
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"actor_email": "actor_email|actor.email|email|user.email", "actor_id": "actor_id|actor.id|actorId|user_id|user.id", "actor_name": "actor_name|actor.name|user.name", "event_type": "eventType|event_type|event_name|action|type", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "_record_id", "name": "eventNumber|accountingPeriodEndDate", "observed_at": "observed_at|updated_at|last_seen_at", "provider_id": "_record_id", "resource_email": "resource_email|target_email|target.email", "resource_id": "resource_id|eventNumber|target_id|target.id|resource.id|object_id", "resource_name": "resource_name|eventNumber|target_name|target.name|resource.name|object_name", "resource_type": "resource_type|target_type|target.type|object_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|_record_id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				Config:           jsonapi.FamilyConfig{IDTemplate: "${eventNumber}-${accountingPeriodEndDate}", EncodeURNID: true, ResourceURNKind: "zuora_revenue_event"},
			...
			},
			{
				...
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"actor_email": "actor_email|actor.email|email|user.email", "actor_id": "actor_id|actor.id|actorId|user_id|user.id", "actor_name": "actor_name|actor.name|user.name", "event_type": "eventType|event_type|event_name|action|type", "evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "_record_id", "name": "revenueScheduleNumber|accountId", "observed_at": "observed_at|updated_at|last_seen_at", "provider_id": "_record_id", "resource_email": "resource_email|target_email|target.email", "resource_id": "resource_id|revenueScheduleNumber|target_id|target.id|resource.id|object_id", "resource_name": "resource_name|revenueScheduleNumber|target_name|target.name|resource.name|object_name", "resource_type": "resource_type|target_type|target.type|object_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|_record_id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				Config:           jsonapi.FamilyConfig{IDTemplate: "${revenueScheduleNumber}-${accountId}", EncodeURNID: true, ResourceURNKind: "zuora_revenue_schedule"},
