		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "sailpoint_identitynow_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "sailpoint_identitynow"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "sailpoint_identitynow_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "sailpoint_identitynow"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "sailpoint_identitynow_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "sailpoint_identitynow"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "sailpoint_identitynow_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "sailpoint_identitynow"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "sailpoint_identitynow_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "sailpoint_identitynow"},
			},
		},
	})
	if err != nil {
