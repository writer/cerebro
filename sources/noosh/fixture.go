...
// NewFixture constructs the deterministic noosh source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"automaticinvitation", "billingrecipient", "clientworkgroup", "clientworkgroups_projecthomeuserfield", "memberrole", "projecthomeuserfield", "supplierworkgroup", "teammember", "teammembersofclientproject", "teamtemplate", "workgroup", "workgroupmember"} {
