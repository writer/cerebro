		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "jamf_pro"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "jamf_pro_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "jamf_pro"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "jamf_pro_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "jamf_pro"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "jamf_pro_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "jamf_pro"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "jamf_pro_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "jamf_pro"},
			},
		},
	})
	if err != nil {
