		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "mosyle"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "mosyle_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "mosyle"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "mosyle_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "mosyle"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "mosyle_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "mosyle"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "mosyle_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "mosyle"},
			},
		},
	})
	if err != nil {
