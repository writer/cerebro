...
// NewFixture constructs the deterministic osisoft source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"analysisruleplugin", "assetserver", "baseelementtemplate", "elements_eventframe", "elementtemplate", "eventframe", "eventframeattribute", "eventframes_eventframe", "eventframes_eventframeattribute", "notificationcontacttemplates_search", "search", "securityidentity"} {
