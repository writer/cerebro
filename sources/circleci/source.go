...
const (
	...
	defaultHealthPath      = "/v2/me"
	defaultBaseURLTemplate = "https://circleci.com/api"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "pipelines", "source_system": "circleci"},
			},
			{
				Name:             familyFindings,
				Path:             "/v1/findings",
				URNKind:          "circleci_findings",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "findings", "source_system": "circleci"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "circleci_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "circleci"},
			},
		},
	})
	if err != nil {
