		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "zylo"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "zylo"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "zylo"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "zylo_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "zylo"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "zylo_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "zylo"},
			},
		},
	})
	if err != nil {
