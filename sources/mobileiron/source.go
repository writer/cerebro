		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "mobileiron"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "mobileiron_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "mobileiron"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "mobileiron_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "mobileiron"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "mobileiron_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "mobileiron"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "mobileiron_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "mobileiron"},
			},
		},
	})
	if err != nil {
