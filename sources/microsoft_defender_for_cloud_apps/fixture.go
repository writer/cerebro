...
// NewFixture constructs the deterministic microsoft_defender_for_cloud_apps source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"assets", "findings", "vulnerabilities"} {
