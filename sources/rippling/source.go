...
const (
	...
	defaultHealthPath      = "/companies"
	defaultBaseURLTemplate = "https://rest.ripplingapis.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "rippling"},
			},
			{
				Name:             familyDevices,
				Path:             "/devices",
				URNKind:          "rippling_devices",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "devices", "source_system": "rippling"},
			},
			{
				Name:             familyBackgroundChecks,
				Path:             "/background-checks",
				URNKind:          "rippling_background_checks",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "background_checks", "source_system": "rippling"},
			},
		},
	})
	if err != nil {
