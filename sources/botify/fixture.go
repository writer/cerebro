...
// NewFixture constructs the deterministic botify source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"analyses", "datamodel", "domain", "export", "filter", "orphan_url", "out_of_config", "percentile", "project", "report", "sitemap_only", "url"} {
