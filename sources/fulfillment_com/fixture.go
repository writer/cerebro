...
// NewFixture constructs the deterministic fulfillment_com source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"accounting", "inventory", "return", "track"} {
