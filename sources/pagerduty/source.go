...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			{Name: "escalation_policy", Path: "/escalation_policies", URNKind: "pagerduty_escalation_policy", IDKeys: []string{"id"}, Attributes: map[string]string{"escalation_policy_id": "id", "name": "name", "summary": "summary", "num_loops": "num_loops", "html_url": "html_url"}, StaticAttributes: map[string]string{"source_product": "pagerduty"}},
			{Name: "integration", Path: "/services/default/integrations", URNKind: "pagerduty_integration", IDKeys: []string{"id"}, Attributes: map[string]string{"integration_id": "id", "name": "name", "summary": "summary", "service_id": "service.id|service_id", "vendor_id": "vendor.id"}, StaticAttributes: map[string]string{"source_product": "pagerduty"}},
