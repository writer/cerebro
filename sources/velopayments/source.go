...
const (
	sourceID                   = "velopayments"
	defaultFamily              = familyDelta
	defaultHealthPath          = "/v4/payments/deltas"
	defaultBaseURLTemplate     = "https://api.sandbox.velopayments.com"
	tokenHeader                = ""
	tokenScheme                = "Bearer"
	oauthTokenURLTemplate      = "https://api.sandbox.velopayments.com/v1/login" // #nosec G101 -- token endpoint URL template, not credential material.
	oauthScopeSeparator        = " "
	oauthTokenExpirationBuffer = 300 * time.Second
	familyDelta                = "delta"
	familySourceaccount        = "sourceaccount"
	familyPaymentchannelrule   = "paymentchannelrule"
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "sourceaccount", "source_system": "velopayments"},
			},
			{
				Name:             familyPaymentchannelrule,
				Path:             "/v1/paymentChannelRules",
				URNKind:          "velopayments_paymentchannelrule",
				IDKeys:           []string{"isoCountryCode", "policy_id", "id", "name", "key", "control_id"},
				ListKeys:         []string{"bank"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "isoCountryCode", "name": "isoCountryCode", "observed_at": "observed_at|updated_at|last_seen_at", "policy_created_at": "created_at|created|date_created", "policy_description": "description|summary|body", "policy_id": "isoCountryCode", "policy_name": "isoCountryCode", "policy_severity": "severity|risk|priority", "policy_status": "policy_status|status|state|enabled", "policy_type": "paymentchannelrule", "resource_id": "resource_id|id|metadata.resource_id", "resource_name": "name|display_name|hostname|metadata.resource_name", "resource_type": "resource_type|type|metadata.resource_type", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "paymentchannelrule", "source_system": "velopayments"},
			},
			{
				Name:             familyWebhook,
				Path:             "/v1/webhooks",
				URNKind:          "velopayments_webhook",
				IDKeys:           []string{"id", "authorizationHeader", "urn", "resource_urn", "name"},
				PageSizeParams:   []string{"pageSize"},
				ListKeys:         []string{"content"},
				TimestampKeys:    []string{"observed_at", "updated_at", "last_seen_at", "created_at"},
				Attributes:       map[string]string{"evidence_cas_commit_id": "evidence_cas.commit_id|evidence_cas_commit_id|commit_id", "evidence_cas_digest": "evidence_cas.digest|evidence_cas_digest|digest", "evidence_cas_merkle_root": "evidence_cas.merkle_root|evidence_cas_merkle_root|merkle_root", "evidence_cas_ref_type": "evidence_cas.ref_type|evidence_cas_ref_type|ref_type", "evidence_cas_uri": "evidence_cas.uri|evidence_cas_uri|uri", "id": "id", "name": "authorizationHeader", "observed_at": "observed_at|updated_at|last_seen_at", "resource_id": "id", "resource_name": "authorizationHeader", "resource_type": "webhook", "resource_urn": "resource_urn|urn|metadata.resource_urn", "source_event_id": "event_id|id|metadata.event_id", "tenant_id": "tenant_id|metadata.tenant_id"},
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "webhook", "source_system": "velopayments"},
			},
		},
	})
	if err != nil {
