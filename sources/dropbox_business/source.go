...
const (
	...
	defaultHealthPath      = "/2/team/get_info"
	defaultBaseURLTemplate = "https://api.dropboxapi.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		OAuthTokenURL:   "https://api.dropboxapi.com/oauth/token",
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "dropbox_business_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "dropbox_business"},
			},
			{
				Name:             familyContentAssets,
				Path:             "/v1/resources",
				URNKind:          "dropbox_business_content_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "content_assets", "source_system": "dropbox_business"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "dropbox_business_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "dropbox_business"},
			},
		},
	})
	if err != nil {
