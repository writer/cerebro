...
const (
	sourceID               = "hudsonrock"
	defaultFamily          = familyInfostealers
	defaultHealthPath      = "/health"
	defaultBaseURLTemplate = "https://cavalier.hudsonrock.com/api"
	tokenHeader            = ""
	tokenScheme            = "Token"
	familyInfostealers     = "infostealers"
...
func New() (*Source, error) {
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			{
				Name:             familyInfostealers,
				Path:             "/infostealers",
				URNKind:          "hudsonrock_infostealers",
				...
				StaticAttributes: map[string]string{"record_class": "finding", "schema": "infostealers", "source_system": "hudsonrock"},
			},
			{
				Name:             familyDomains,
				Path:             "/domains",
				URNKind:          "hudsonrock_domains",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "domains", "source_system": "hudsonrock"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/audit-events",
				URNKind:          "hudsonrock_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "hudsonrock"},
			},
		},
	})
	if err != nil {
