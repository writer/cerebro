		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "miradore"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "miradore_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "miradore"},
			},
			{
				Name:             familyRoles,
				Path:             "/v1/roles",
				URNKind:          "miradore_roles",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "roles", "source_system": "miradore"},
			},
			{
				Name:             familyApplications,
				Path:             "/v1/applications",
				URNKind:          "miradore_applications",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "applications", "source_system": "miradore"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "miradore_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "miradore"},
			},
		},
	})
	if err != nil {
