...
const (
	...
	defaultHealthPath          = "/v1.0/organization"
	...
	inner, err := jsonapi.New(spec, jsonapi.Options{
		...
		Families: []jsonapi.Family{
			...
			},
			{
				...
				Config:               jsonapi.FamilyConfig{EncodeURNID: true},
				IncrementalWatermark: true,
			},
		},
	})
