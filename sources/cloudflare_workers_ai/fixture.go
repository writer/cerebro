...
// NewFixture constructs the deterministic cloudflare_workers_ai source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"ai_gateways", "gateway_evaluations", "gateway_logs", "gateway_provider_configs", "model_catalog", "vectorize_indexes"} {
