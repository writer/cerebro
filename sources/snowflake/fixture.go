...
// NewFixture constructs the deterministic snowflake source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"assets", "audit_events", "cortex_search_services", "vulnerabilities"} {
