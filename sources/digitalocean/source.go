...
const (
	...
	defaultHealthPath      = "/account"
	defaultBaseURLTemplate = "https://api.digitalocean.com/v2"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "droplets", "source_system": "digitalocean"},
			},
			{
				Name:             familyTeams,
				Path:             "/teams",
				URNKind:          "digitalocean_teams",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "teams", "source_system": "digitalocean"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/actions",
				URNKind:          "digitalocean_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "digitalocean"},
			},
		},
	})
	if err != nil {
