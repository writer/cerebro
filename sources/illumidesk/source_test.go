...
func TestSourceCheckAndRead(t *testing.T) {
	...
	defer server.Close()
	cfgValues := map[string]string{"tenant_id": "tenant", "base_url": server.URL, "family": defaultFamily, "api_token": "test-token", "entity": "test-entity", "namespace": "test-namespace", "project": "test-project", "team": "test-team", "user": "test-user"}
