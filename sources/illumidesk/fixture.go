...
// NewFixture constructs the deterministic illumidesk source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"application", "card", "deployment", "email", "entity", "group", "invoice", "notification", "profile", "server_size", "setting", "team"} {
