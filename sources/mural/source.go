		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "mural"},
			},
			{
				Name:             familyGroups,
				Path:             "/v1/groups",
				URNKind:          "mural_groups",
				...
				StaticAttributes: map[string]string{"record_class": "identity_group", "schema": "groups", "source_system": "mural"},
			},
			{
				Name:             familyWorkspaces,
				Path:             "/v1/workspaces",
				URNKind:          "mural_workspaces",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "workspaces", "source_system": "mural"},
			},
			{
				Name:             familyDocuments,
				Path:             "/v1/documents",
				URNKind:          "mural_documents",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "documents", "source_system": "mural"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "mural_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "mural"},
			},
		},
	})
	if err != nil {
