		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "microsoft_365"},
			},
			{
				Name:             familyContentAssets,
				Path:             "/v1/resources",
				URNKind:          "microsoft_365_content_assets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "content_assets", "source_system": "microsoft_365"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "microsoft_365_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "microsoft_365"},
			},
		},
	})
	if err != nil {
