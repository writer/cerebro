		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "zeet"},
			},
			{
				Name:             familyProjects,
				Path:             "/v1/projects",
				URNKind:          "zeet_projects",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "zeet"},
			},
			{
				Name:             familyRepositories,
				Path:             "/v1/repositories",
				URNKind:          "zeet_repositories",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "repositories", "source_system": "zeet"},
			},
			{
				Name:             familyDeployments,
				Path:             "/v1/deployments",
				URNKind:          "zeet_deployments",
				...
				StaticAttributes: map[string]string{"record_class": "deployment", "schema": "deployments", "source_system": "zeet"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "zeet_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "zeet"},
			},
		},
	})
	if err != nil {
