...
const (
	...
	defaultFamily          = familyMonitors
	defaultHealthPath      = "/getAccountDetails"
	defaultBaseURLTemplate = "https://api.uptimerobot.com/v2"
	tokenHeader            = ""
	tokenScheme            = "Token"
	familyMonitors         = "monitors"
	familyAlertContacts    = "alert_contacts"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "monitors", "source_system": "uptimerobot"},
			},
			{
				Name:             familyAlertContacts,
				Path:             "/getAlertContacts",
				URNKind:          "uptimerobot_alert_contacts",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "alert_contacts", "source_system": "uptimerobot"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/getAuditLog",
				URNKind:          "uptimerobot_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "uptimerobot"},
			},
		},
	})
	if err != nil {
