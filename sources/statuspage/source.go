...
const (
	...
	defaultHealthPath      = "/v1/pages"
	defaultBaseURLTemplate = "https://api.statuspage.io"
	tokenHeader            = ""
	tokenScheme            = "Token"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "statuspage"},
			},
			{
				Name:             familyTickets,
				Path:             "/v1/tickets",
				URNKind:          "statuspage_tickets",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "tickets", "source_system": "statuspage"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "statuspage_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "statuspage"},
			},
		},
	})
	if err != nil {
