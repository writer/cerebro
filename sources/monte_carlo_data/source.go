		...
		Families: []jsonapi.Family{
			{
				Name:             familyUsers,
				Path:             "/v1/users",
				URNKind:          "monte_carlo_data_users",
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "monte_carlo_data"},
			},
			{
				Name:             familyAccounts,
				Path:             "/v1/accounts",
				URNKind:          "monte_carlo_data_accounts",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "accounts", "source_system": "monte_carlo_data"},
			},
			{
				Name:             familyRecords,
				Path:             "/v1/records",
				URNKind:          "monte_carlo_data_records",
				IDKeys:           []string{"id", "name", "urn", "resource_urn"},
				CursorParam:      "cursor",
				NextCursorKeys:   []string{"next_cursor"},
				PageSizeParams:   []string{"limit"},
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "records", "source_system": "monte_carlo_data"},
			},
			{
				Name:             familyPolicies,
				Path:             "/v1/policies",
				URNKind:          "monte_carlo_data_policies",
				...
				StaticAttributes: map[string]string{"record_class": "policy", "schema": "policies", "source_system": "monte_carlo_data"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit_events",
				URNKind:          "monte_carlo_data_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "monte_carlo_data"},
			},
		},
	})
	if err != nil {
