...
const (
	...
	defaultHealthPath      = "/v2"
	defaultBaseURLTemplate = "https://api.monday.com"
	tokenHeader            = ""
	tokenScheme            = "Bearer"
	familyUsers            = "users"
		...
		Families: []jsonapi.Family{
			{
				...
				StaticAttributes: map[string]string{"record_class": "identity_user", "schema": "users", "source_system": "monday_com"},
			},
			{
				Name:             familyProjects,
				Path:             "/v1/projects",
				URNKind:          "monday_com_projects",
				...
				StaticAttributes: map[string]string{"record_class": "asset", "schema": "projects", "source_system": "monday_com"},
			},
			{
				Name:             familyAuditEvents,
				Path:             "/v1/audit/events",
				URNKind:          "monday_com_audit_events",
				...
				StaticAttributes: map[string]string{"record_class": "audit_event", "schema": "audit_events", "source_system": "monday_com"},
			},
		},
	})
	if err != nil {
