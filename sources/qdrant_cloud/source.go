		...
		Families: []jsonapi.Family{
			{
				...
				Attributes: map[string]string{
					"account_owner_email": "ownerEmail|owner_email",
			...
			},
			{
				...
				Attributes: map[string]string{
					"created_at":         "accountMember.createdAt|account_member.created_at",
					"default_account_id": "accountMember.defaultAccountId|account_member.default_account_id",
					"display_name":       "accountMember.email|account_member.email",
					"email":              "accountMember.email|account_member.email",
					"is_owner":           "isOwner|is_owner",
					"observed_at":        "accountMember.lastModifiedAt|accountMember.createdAt|account_member.last_modified_at|account_member.created_at",
					"primary_email":      "accountMember.email|account_member.email",
					"resource_id":        "accountMember.id|account_member.id",
					"resource_name":      "accountMember.email|account_member.email",
					"source_event_id":    "accountMember.id|account_member.id",
					"status":             "accountMember.status|account_member.status",
					"user_id":            "accountMember.id|account_member.id",
				},
			...
			},
			{
				...
				Attributes: map[string]string{
					"cloud_provider_id":        "cloudProviderId|cloud_provider_id",
					"cloud_provider_region_id": "cloudProviderRegionId|cloud_provider_region_id",
					"deployment_created_at":    "createdAt|created_at",
					"deployment_environment":   "cloudProviderRegionId|cloud_provider_region_id|cloudProviderId|cloud_provider_id",
					"deployment_id":            "id",
					"deployment_name":          "name",
					"deployment_status":        "state.phase|phase",
					"deployment_updated_at":    "configuration.lastModifiedAt|state.restartedAt|configuration.last_modified_at|state.restarted_at|createdAt|created_at",
					"deployment_url":           "state.endpoint.url|endpoint.url",
					"observed_at":              "configuration.lastModifiedAt|state.restartedAt|createdAt|configuration.last_modified_at|state.restarted_at|created_at",
					"qdrant_version":           "state.version|configuration.version|version",
					"resource_id":              "id",
					"resource_name":            "name",
					"source_event_id":          "id",
				},
			...
			},
			{
				...
				Attributes: map[string]string{
					...
					"created_by_email":  "createdByEmail|created_by_email",
					"expires_at":        "expiresAt|expires_at",
					"observed_at":       "createdAt|created_at",
					"postfix":           "postfix",
					"resource_id":       "id",
					"resource_name":     "name",
					"secret_created_at": "createdAt|created_at",
					"secret_id":         "id",
					"secret_name":       "name",
					"source_event_id":   "id",
				},
