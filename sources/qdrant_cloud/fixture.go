...
// NewFixture constructs the deterministic qdrant_cloud source used by tests.
func NewFixture() (sourcecdk.Source, error) {
	...
	for _, family := range []string{"account_members", "accounts", "backup_restores", "backup_schedules", "backups", "clusters", "database_api_keys", "roles"} {
