...
//!
//! The focused IAM modules own service-account request and response parity.
//! This facade reexports that public API and retains the bounded GCS object
//! content decision without accepting credentials or performing provider I/O.
