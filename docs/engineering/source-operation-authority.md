...
- Required entrypoint-to-route and route-to-security-boundary direct structural call edges must remain reachable in the AST, unshadowed, and present with their reviewed cardinality.
