...
| `fivetran` | Fivetran source | fivetran.users, fivetran.user_connections, fivetran.user_groups, fivetran.roles, fivetran.teams, fivetran.team_users, fivetran.team_connections, fivetran.team_groups, fivetran.groups, fivetran.group_users, fivetran.group_connections, fivetran.destinations, fivetran.connections, fivetran.connection_certificates, fivetran.connection_fingerprints, fivetran.connection_schemas, fivetran.connection_state, fivetran.connector_sdk_packages, fivetran.destination_certificates, fivetran.destination_fingerprints, fivetran.log_services, fivetran.webhooks, fivetran.external_secret_managers, fivetran.external_secret_manager_entities, fivetran.external_secret_manager_assignments, fivetran.private_links, fivetran.proxy_agents, fivetran.proxy_agent_connections, fivetran.hybrid_deployment_agents, fivetran.public_connector_types, fivetran.connector_metadata, fivetran.system_keys, fivetran.transformations, fivetran.transformation_projects, fivetran.transformation_package_metadata |
