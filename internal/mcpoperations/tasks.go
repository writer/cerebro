...
func TaskToolDefinitions(limits TaskToolLimits) []TaskToolDefinition {
	...
	return []TaskToolDefinition{
		...
		{Name: "cerebro.evidence.packet", Title: "Prepare Evidence Packet", Description: "Collect an authorized proof bundle for an auditor, control, or decision packet using current evidence coverage and verifier contracts. The tool never approves or executes an action and reports blocked or partial task states." + readScope, InputSchema: objectSchema(map[string]any{
