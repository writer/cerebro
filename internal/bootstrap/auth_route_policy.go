...
var httpAuthRoutePolicies = []httpAuthRoutePolicy{
	...
	{Method: http.MethodPost, Exact: "/ask-queries", Scope: scopeCosmoSecurityRead, Static: true},
	{Method: http.MethodPatch, Prefix: "/ask-queries/", Scope: scopeCosmoSecurityRead},
	{Method: http.MethodDelete, Prefix: "/ask-queries/", Scope: scopeCosmoSecurityRead},
