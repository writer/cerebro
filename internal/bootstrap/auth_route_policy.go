...
var httpAuthRoutePolicies = []httpAuthRoutePolicy{
	...
	{Method: http.MethodGet, Exact: "/grc/work-items", Scope: scopeComplianceWorkRead, Static: true},
	{Method: http.MethodGet, Prefix: "/grc/work-items/", Scope: scopeComplianceWorkRead},
