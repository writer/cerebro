...
var httpAuthRoutePolicies = []httpAuthRoutePolicy{
	...
	{Method: http.MethodGet, Exact: "/platform/audit-events", Scope: scopeCosmoSecurityRead, Static: true},
	{Method: http.MethodGet, Exact: "/v1/security/lifecycle", Scope: scopeCosmoSecurityRead, Static: true},
	...
	{Method: http.MethodGet, Exact: "/policy-candidates", Scope: scopeCosmoSecurityRead, Static: true},
	{Method: http.MethodGet, Prefix: "/policy-candidates/", Suffix: "/evaluation-datasets", Scope: scopePolicyEvaluationDatasetsRead},
	{Method: http.MethodGet, Prefix: "/policy-candidates/", Suffix: "/experiments", Scope: scopePolicyCandidatesWrite},
	{Method: http.MethodGet, Prefix: "/policy-candidates/", Scope: scopeCosmoSecurityRead},
	{Method: http.MethodPost, Exact: "/policy-candidates", Scope: scopePolicyCandidatesWrite, Static: true},
	{Method: http.MethodPost, Prefix: "/policy-candidates/", Suffix: "/evaluation-datasets", Scope: scopePolicyCandidatesWrite},
	{Method: http.MethodPost, Prefix: "/policy-candidates/", Suffix: "/experiments", Scope: scopePolicyCandidatesWrite},
	{Method: http.MethodPost, Prefix: "/policy-candidates/", Suffix: "/prove", Scope: scopePolicyCandidatesWrite},
	{Method: http.MethodPost, Prefix: "/policy-candidates/", Suffix: "/shadow", Scope: scopePolicyCandidatesWrite},
	{Method: http.MethodGet, Prefix: "/policy-evaluation-datasets/", Scope: scopePolicyEvaluationDatasetsRead},
	{Method: http.MethodPost, Prefix: "/policy-evaluation-datasets/", Suffix: "/revisions", Scope: scopePolicyCandidatesWrite},
	{Method: http.MethodGet, Prefix: "/policy-experiments/", Suffix: "/observations", Scope: scopePolicyCandidatesWrite},
	{Method: http.MethodGet, Prefix: "/policy-experiments/", Scope: scopePolicyCandidatesWrite},
	{Method: http.MethodPost, Prefix: "/policy-experiments/", Suffix: "/run", Scope: scopePolicyCandidatesWrite},
	...
	{Method: http.MethodPost, Prefix: "/grc/evidence-claims/", Scope: scopeGRCInventoryWrite},
	...
	{Method: http.MethodPost, Exact: "/grc/work-items", Scope: scopeFindingLifecycleWrite, Static: true},
	{Method: http.MethodPost, Prefix: "/grc/work-items/", Suffix: "/commands", Scope: scopeFindingLifecycleWrite},
	{Method: http.MethodPost, Exact: "/grc/remediation-plans", Scope: scopeFindingLifecycleWrite, Static: true},
	{Method: http.MethodPost, Prefix: "/grc/remediation-plans/", Suffix: "/commands", Scope: scopeFindingLifecycleWrite},
