...
var httpAuthRoutePolicies = []httpAuthRoutePolicy{
	...
	{Method: http.MethodGet, Prefix: "/policy-candidates/", Suffix: "/evaluation-datasets", Scope: scopePolicyCandidatesWrite},
	...
	{Method: http.MethodGet, Prefix: "/policy-evaluation-datasets/", Scope: scopePolicyCandidatesWrite},
