...
var httpAuthRoutePolicies = []httpAuthRoutePolicy{
	...
	{Method: http.MethodPost, Prefix: "/grc/vendors/", Suffix: "/questionnaire-reviews", Scope: scopeGRCInventoryWrite},
	{Method: http.MethodPost, Prefix: "/grc/vendor-questionnaire-reviews/", Suffix: "/process", Scope: scopeGRCInventoryWrite},
	{Method: http.MethodPost, Prefix: "/grc/vendor-questionnaire-reviews/", Suffix: "/assignments", Scope: scopeGRCInventoryWrite},
	{Method: http.MethodPost, Prefix: "/grc/vendor-questionnaire-reviews/", Suffix: "/comments", Scope: scopeGRCInventoryWrite},
	{Method: http.MethodPost, Prefix: "/grc/vendor-questionnaire-reviews/", Suffix: "/approvals", Scope: scopeGRCInventoryWrite},
