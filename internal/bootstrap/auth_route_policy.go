...
var httpAuthRoutePolicies = []httpAuthRoutePolicy{
	...
	{Method: http.MethodGet, Exact: "/grc/programs", Scope: scopeComplianceProgramsRead, Static: true},
	{Method: http.MethodGet, Prefix: "/grc/programs/", Scope: scopeComplianceProgramsRead},
	{Method: http.MethodGet, Prefix: "/grc/control-implementations/", Scope: scopeComplianceProgramsRead},
	{Method: http.MethodGet, Exact: "/grc/evidence-artifacts", Scope: scopeComplianceEvidenceRead, Static: true},
	{Method: http.MethodGet, Prefix: "/grc/evidence-artifacts/", Scope: scopeComplianceEvidenceRead},
	{Method: http.MethodGet, Exact: "/grc/assessment-plans", Scope: scopeComplianceAssessmentsRead, Static: true},
	{Method: http.MethodGet, Prefix: "/grc/assessment-plans/", Scope: scopeComplianceAssessmentsRead},
	{Method: http.MethodGet, Exact: "/grc/compliance-assessments", Scope: scopeComplianceAssessmentsRead, Static: true},
	{Method: http.MethodGet, Prefix: "/grc/compliance-assessments/", Scope: scopeComplianceAssessmentsRead},
	{Method: http.MethodGet, Prefix: "/grc/compliance-results/", Scope: scopeComplianceAssessmentsRead},
	{Method: http.MethodGet, Prefix: "/grc/compliance-reviews/", Scope: scopeComplianceAssessmentsRead},
	{Method: http.MethodGet, Exact: "/grc/compliance-work-items", Scope: scopeComplianceWorkRead, Static: true},
	{Method: http.MethodGet, Prefix: "/grc/compliance-work-items/", Scope: scopeComplianceWorkRead},
