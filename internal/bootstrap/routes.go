...
func (app *App) registerGRCRoutes(mux *http.ServeMux) {
	...
	questionnaires := app.grcVendorQuestionnaireHandler()
	registerHTTPRoute(mux, "GET /grc/vendors/{vendorID}/questionnaire-reviews", routeSurfacePlatformHTTP, app.cacheGRCJSON(app.grcCachePolicy("vendor.questionnaire_reviews", time.Minute, grcCacheScopeGraph, grcCacheScopeFindings, grcCacheScopeEvidence, grcCacheScopeRuntime), questionnaires.GRCVendorQuestionnaireReviews))
	registerHTTPRoute(mux, "POST /grc/vendors/{vendorID}/questionnaire-reviews", routeSurfacePlatformHTTP, questionnaires.CreateGRCVendorQuestionnaireReview)
	registerHTTPRoute(mux, "GET /grc/vendor-questionnaire-reviews/{reviewID}", routeSurfacePlatformHTTP, questionnaires.GetGRCVendorQuestionnaireReview)
	registerHTTPRoute(mux, "POST /grc/vendor-questionnaire-reviews/{reviewID}/process", routeSurfacePlatformHTTP, questionnaires.ProcessGRCVendorQuestionnaireReview)
	registerHTTPRoute(mux, "POST /grc/vendor-questionnaire-reviews/{reviewID}/assignments", routeSurfacePlatformHTTP, questionnaires.AssignGRCVendorQuestionnaireReview)
	registerHTTPRoute(mux, "POST /grc/vendor-questionnaire-reviews/{reviewID}/comments", routeSurfacePlatformHTTP, questionnaires.CommentGRCVendorQuestionnaireReview)
	registerHTTPRoute(mux, "POST /grc/vendor-questionnaire-reviews/{reviewID}/approvals", routeSurfacePlatformHTTP, questionnaires.ApproveGRCVendorQuestionnaireReview)
