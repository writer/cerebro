...
func TestRoutePermissionCoverage(t *testing.T) {
	tests := []struct {
		...
		{name: "platform scan audit list", method: http.MethodGet, path: "/api/v1/platform/scan-audit", expectedRB: "platform.jobs.read"},
		...
		{name: "forensics capture write", method: http.MethodPost, path: "/api/v1/forensics/capture", expectedRB: "security.incidents.manage"},
		{name: "forensics export read uses manage scope", method: http.MethodGet, path: "/api/v1/forensics/evidence/e-1/export", expectedRB: "security.incidents.manage"},
