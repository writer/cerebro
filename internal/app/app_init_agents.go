...
func (a *App) securityAgentTools(cfg *Config) []agents.Tool {
	...
	warehouseClient := a.Warehouse
	if warehouseClient == nil {
		switch {
		case a.PostgresClient != nil:
			warehouseClient = a.PostgresClient
		case a.Snowflake != nil:
			warehouseClient = a.Snowflake
		case a.LegacySnowflake != nil:
			warehouseClient = a.LegacySnowflake
		}
	}
	...
	return agents.NewSecurityTools(warehouseClient, a.Findings, a.Policy, scmClient).GetTools()
}
