...
func (a *App) securityAgentTools(cfg *Config) []agents.Tool {
	...
	var assets warehouse.DataWarehouse
	if a.Warehouse != nil {
		assets = a.Warehouse
	} else if a.Snowflake != nil {
		assets = a.Snowflake
	} else if a.LegacySnowflake != nil {
		assets = a.LegacySnowflake
	}
	...
	return agents.NewSecurityTools(assets, a.Findings, a.Policy, scmClient).GetTools()
}
