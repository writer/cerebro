...
func LoadConfig() *Config {
	...
	cfg := &Config{
		...
		NATSConsumerStream:                  getEnv("NATS_CONSUMER_STREAM", "CEREBRO_EVENTS"),
		NATSConsumerSubjects:                splitCSV(getEnv("NATS_CONSUMER_SUBJECTS", "cerebro.events.>")),
		...
		AlertRouterNotifyPrefix:             getEnv("ALERT_ROUTER_NOTIFY_PREFIX", "cerebro.notify"),
		AgentRemoteToolsEnabled:             getEnvBool("AGENT_REMOTE_TOOLS_ENABLED", false),
		AgentRemoteToolsManifestSubject:     getEnv("AGENT_REMOTE_TOOLS_MANIFEST_SUBJECT", "cerebro.tools.manifest"),
		AgentRemoteToolsRequestPrefix:       getEnv("AGENT_REMOTE_TOOLS_REQUEST_PREFIX", "cerebro.tools.request"),
