...
var ResourceToTableMapping = map[string][]string{
	...
	"gcp::artifact_registry::image":      {"gcp_artifact_registry_images"},
	"gcp::artifactregistry::image":       {"gcp_artifact_registry_images"},
	"gcp::container_registry::registry":  {"gcp_artifact_registry_repositories"},
	"gcp::container_registry::image":     {"gcp_artifact_registry_images"},
	...
	"azure::containerservice::managed_cluster": {"azure_aks_clusters"},
	"azure::containerservice::managedcluster":  {"azure_aks_clusters"},
	"azure::containerservice::agent_pool":      {"azure_aks_node_pools"},
	"azure::containerservice::agentpool":       {"azure_aks_node_pools"},
	...
	"container::cluster":         {"aws_eks_clusters", "gcp_container_clusters", "azure_aks_clusters"},
	"container::node_pool":       {"aws_eks_node_groups", "gcp_container_node_pools", "azure_aks_node_pools"},
	"container::pod":             {"k8s_core_pods"},
	"container::deployment":      {"k8s_apps_deployments"},
	"container::image":           {"snyk_container_images", "aws_ecr_images", "gcp_artifact_registry_images"},
	"ai::model":                  {"ai_models"},
	"ai::endpoint":               {"ai_models"},
	"vendors":                    {"vendors"},
	"org::system":                {"org_topology_systems"},
	"org::team_pair":             {"org_topology_team_pairs"},
	"org::customer_relationship": {"org_topology_customer_relationships"},
	"org::person":                {"org_topology_people"},
}
