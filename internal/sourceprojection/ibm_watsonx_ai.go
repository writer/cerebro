...
func ibmWatsonxAiFoundationModelSpecsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return ibmWatsonxAiGenericAssetProjections(event)
}

func ibmWatsonxAiFoundationModelTasksProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return ibmWatsonxAiGenericAssetProjections(event)
}

func ibmWatsonxAiCustomModelsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return ibmWatsonxAiGenericAssetProjections(event)
}

func ibmWatsonxAiDeploymentsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return ibmWatsonxAiGenericDeploymentProjections(event)
}

func ibmWatsonxAiTrainingJobsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return ibmWatsonxAiGenericDeploymentProjections(event)
}

func ibmWatsonxAiGenericAssetProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
...
func ibmWatsonxAiGenericDeploymentProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	tenantID, err := tenantID(event)
	if err != nil {
		return nil, nil, err
	}
