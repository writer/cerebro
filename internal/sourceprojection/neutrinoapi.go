...
func neutrinoapiIpBlocklistProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return neutrinoapiGenericAssetProjections(event)
}

func neutrinoapiHostReputationProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return neutrinoapiGenericAssetProjections(event)
}

func neutrinoapiBinLookupProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return neutrinoapiGenericAssetProjections(event)
}

func neutrinoapiGeocodeAddressProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return neutrinoapiGenericAssetProjections(event)
}

func neutrinoapiGenericAssetProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
