...
func TestProjectOpenAIProjectAccessEdges(t *testing.T) {
	...
	credentialURN := "urn:cerebro:writer:openai_credential:id_123" // #nosec G101 -- synthetic projected URN in a test fixture.
...
func TestProjectAnthropicWorkspaceCredentialFederationAndComplianceEdges(t *testing.T) {
	...
	credentialURN := "urn:cerebro:writer:anthropic_credential:id_123" // #nosec G101 -- synthetic projected URN in a test fixture.
