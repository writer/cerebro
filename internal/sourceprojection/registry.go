...
var builtinRegistry = &Registry{projectors: map[string]ProjectFunc{
	...
	"anthropic.analytics_cost":                      genericInventoryProjections,
	"anthropic.compliance_activity":                 genericInventoryProjections,
	"anthropic.cost_report":                         genericInventoryProjections,
	"anthropic.external_key":                        genericInventoryProjections,
	"anthropic.federation_issuer":                   genericInventoryProjections,
	"anthropic.federation_rule":                     genericInventoryProjections,
	"anthropic.invite":                              genericInventoryProjections,
	"anthropic.organization":                        genericInventoryProjections,
	"anthropic.rate_limit":                          genericInventoryProjections,
	"anthropic.service_account":                     genericInventoryProjections,
	"anthropic.spend_limit":                         genericInventoryProjections,
	"anthropic.spend_limit_increase_request":        genericInventoryProjections,
	"anthropic.usage_report_claude_code":            genericInventoryProjections,
	"anthropic.usage_report_message":                genericInventoryProjections,
	"anthropic.user":                                genericInventoryProjections,
	"anthropic.workspace":                           genericInventoryProjections,
	"anthropic.workspace_member":                    genericInventoryProjections,
	"anthropic.workspace_rate_limit":                genericInventoryProjections,
	...
	"openai.audit_log":                              genericInventoryProjections,
	"openai.certificate":                            genericInventoryProjections,
	"openai.cost":                                   genericInventoryProjections,
	"openai.data_retention":                         genericInventoryProjections,
	"openai.group":                                  genericInventoryProjections,
	"openai.group_role":                             genericInventoryProjections,
	"openai.group_user":                             genericInventoryProjections,
	"openai.invite":                                 genericInventoryProjections,
	"openai.project":                                genericInventoryProjections,
	"openai.project_api_key":                        genericInventoryProjections,
	"openai.project_certificate":                    genericInventoryProjections,
	"openai.project_data_retention":                 genericInventoryProjections,
	"openai.project_group":                          genericInventoryProjections,
	"openai.project_group_role":                     genericInventoryProjections,
	"openai.project_hosted_tool_permission":         genericInventoryProjections,
	"openai.project_model_permission":               genericInventoryProjections,
	"openai.project_rate_limit":                     genericInventoryProjections,
	"openai.project_role":                           genericInventoryProjections,
	"openai.project_service_account":                genericInventoryProjections,
	"openai.project_spend_alert":                    genericInventoryProjections,
	"openai.project_user":                           genericInventoryProjections,
	"openai.project_user_role":                      genericInventoryProjections,
	"openai.role":                                   genericInventoryProjections,
	"openai.service_account":                        genericInventoryProjections,
	"openai.spend_alert":                            genericInventoryProjections,
	"openai.usage_audio_speech":                     genericInventoryProjections,
	"openai.usage_audio_transcription":              genericInventoryProjections,
	"openai.usage_code_interpreter_session":         genericInventoryProjections,
	"openai.usage_completion":                       genericInventoryProjections,
	"openai.usage_embedding":                        genericInventoryProjections,
	"openai.usage_file_search_call":                 genericInventoryProjections,
	"openai.usage_image":                            genericInventoryProjections,
	"openai.usage_moderation":                       genericInventoryProjections,
	"openai.usage_vector_store":                     genericInventoryProjections,
	"openai.usage_web_search_call":                  genericInventoryProjections,
	"openai.user":                                   genericInventoryProjections,
	"openai.user_role":                              genericInventoryProjections,
