...
var builtinRegistry = &Registry{projectors: map[string]ProjectFunc{
	...
	// fivetran projectors
	"fivetran.connector_metadata":                fivetranAssetsProjections,
	"fivetran.connector_sdk_packages":            fivetranAssetsProjections,
	"fivetran.connection_certificates":           fivetranAssetsProjections,
	"fivetran.connection_fingerprints":           fivetranAssetsProjections,
	"fivetran.connections":                       fivetranAssetsProjections,
	"fivetran.destination_certificates":          fivetranAssetsProjections,
	"fivetran.destination_fingerprints":          fivetranAssetsProjections,
	"fivetran.destinations":                      fivetranAssetsProjections,
	"fivetran.external_secrets_manager_entities": fivetranAssetsProjections,
	"fivetran.external_secrets_managers":         fivetranAssetsProjections,
	"fivetran.group_connections":                 fivetranAssetsProjections,
	"fivetran.group_users":                       fivetranGroupUsersProjections,
	"fivetran.groups":                            fivetranGroupsProjections,
	"fivetran.hybrid_deployment_agents":          fivetranAssetsProjections,
	"fivetran.log_services":                      fivetranAssetsProjections,
	"fivetran.private_links":                     fivetranAssetsProjections,
	"fivetran.proxy_agent_connections":           fivetranAssetsProjections,
	"fivetran.proxy_agents":                      fivetranAssetsProjections,
	"fivetran.roles":                             fivetranRolesProjections,
	"fivetran.system_keys":                       fivetranAssetsProjections,
	"fivetran.team_connections":                  fivetranTeamConnectionsProjections,
	"fivetran.team_groups":                       fivetranTeamGroupsProjections,
	"fivetran.team_users":                        fivetranTeamUsersProjections,
	"fivetran.teams":                             fivetranTeamsProjections,
	"fivetran.transformation_package_metadata":   fivetranAssetsProjections,
	"fivetran.transformation_projects":           fivetranAssetsProjections,
	"fivetran.transformations":                   fivetranAssetsProjections,
	"fivetran.user_connection_memberships":       fivetranUserConnectionMembershipsProjections,
	"fivetran.user_group_memberships":            fivetranUserGroupMembershipsProjections,
	"fivetran.users":                             fivetranUsersProjections,
	"fivetran.webhooks":                          fivetranAssetsProjections,
