...
var builtinRegistry = &Registry{projectors: map[string]ProjectFunc{
	...
	"aws.identity_store_group":                  awsIdentityStoreGroupProjections,
	"aws.identity_store_group_membership":       awsIdentityStoreGroupMembershipProjections,
	"aws.identity_store_user":                   awsIdentityStoreUserProjections,
	...
	"anthropic.user":                            genericInventoryProjections,
	"anthropic.workspace":                       genericInventoryProjections,
	"cloudflare.account":                        genericInventoryProjections,
	"cloudflare.dns_record":                     genericInventoryProjections,
	"cloudflare.member":                         genericInventoryProjections,
	...
	"openai.admin_api_key":                      genericInventoryProjections,
	"openai.api_key":                            genericInventoryProjections,
	"openai.project":                            genericInventoryProjections,
	"openai.service_account":                    genericInventoryProjections,
	"openai.user":                               genericInventoryProjections,
