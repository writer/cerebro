...
var builtinRegistry = &Registry{projectors: map[string]ProjectFunc{
	...
	"aws.api_gateway_integration":            awsCloudResourceProjections,
	"aws.api_gateway_route":                  awsCloudResourceProjections,
	"aws.api_gateway_stage":                  awsCloudResourceProjections,
	...
	"aws.elb_listener":                       awsCloudResourceProjections,
	"aws.elb_target_group":                   awsCloudResourceProjections,
