...
var builtinRegistry = &Registry{projectors: map[string]ProjectFunc{
	...
	"aws.vpc_lattice_service":                awsVPCLatticeServiceProjections,
	"aws.vpc_lattice_listener":               awsVPCLatticeListenerProjections,
	"aws.vpc_lattice_target_group":           awsVPCLatticeTargetGroupProjections,
