...
var builtinRegistry = &Registry{projectors: map[string]ProjectFunc{
	...
	"aws.docdb_instance":                        awsCloudResourceProjections,
	...
	"aws.elasticache_cluster":                   awsCloudResourceProjections,
	"aws.elasticache_replication_group":         awsCloudResourceProjections,
	"aws.elasticache_subnet_group":              awsCloudResourceProjections,
	"aws.globalaccelerator_accelerator":         awsCloudResourceProjections,
	"aws.globalaccelerator_listener":            awsCloudResourceProjections,
	"aws.globalaccelerator_endpoint_group":      awsCloudResourceProjections,
	"aws.vpclattice_service":                    awsCloudResourceProjections,
	"aws.vpclattice_listener":                   awsCloudResourceProjections,
	"aws.vpclattice_target_group":               awsCloudResourceProjections,
	...
	"aws.fsx_file_system":                       awsCloudResourceProjections,
	...
	"aws.neptune_instance":                      awsCloudResourceProjections,
	"aws.organizations_account":                 awsCloudResourceProjections,
	"aws.organizations_organizational_unit":     awsCloudResourceProjections,
	"aws.organizations_policy":                  awsCloudResourceProjections,
	"aws.opensearch_domain":                     awsCloudResourceProjections,
