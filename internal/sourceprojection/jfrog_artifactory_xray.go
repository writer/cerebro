...
func jfrogArtifactoryXrayAssetsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return jfrogArtifactoryXrayGenericAssetProjections(event)
}

func jfrogArtifactoryXrayFindingsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return jfrogArtifactoryXrayGenericFindingProjections(event)
}

func jfrogArtifactoryXrayVulnerabilitiesProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return jfrogArtifactoryXrayGenericFindingProjections(event)
}

func jfrogArtifactoryXrayGenericAssetProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
...
func jfrogArtifactoryXrayGenericFindingProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	tenantID, err := tenantID(event)
	if err != nil {
		return nil, nil, err
	}
