...
func visiblethreadWebscanProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return visiblethreadGenericAssetProjections(event)
}

func visiblethreadDocumentProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return visiblethreadGenericAssetProjections(event)
}

func visiblethreadWeburlProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return visiblethreadGenericAssetProjections(event)
}

func visiblethreadDocument2Projections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return visiblethreadGenericAssetProjections(event)
}

func visiblethreadGenericAssetProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
