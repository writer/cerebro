...
func googleVertexAiModelsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return googleVertexAiGenericAssetProjections(event)
}

func googleVertexAiEndpointsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return googleVertexAiGenericDeploymentProjections(event)
}

func googleVertexAiCustomJobsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return googleVertexAiGenericDeploymentProjections(event)
}

func googleVertexAiBatchPredictionJobsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return googleVertexAiGenericDeploymentProjections(event)
}

func googleVertexAiIndexesProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return googleVertexAiGenericAssetProjections(event)
}

func googleVertexAiReasoningEnginesProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return googleVertexAiGenericDeploymentProjections(event)
}

func googleVertexAiGenericAssetProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
...
func googleVertexAiGenericDeploymentProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	tenantID, err := tenantID(event)
	if err != nil {
		return nil, nil, err
	}
