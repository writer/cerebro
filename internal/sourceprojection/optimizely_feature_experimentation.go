...
func optimizelyFeatureExperimentationUsersProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return identityUserProjections(event, identityProjectionProfile{Provider: "optimizely_feature_experimentation"})
}

func optimizelyFeatureExperimentationProjectsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return optimizelyFeatureExperimentationGenericAssetProjections(event)
}

func optimizelyFeatureExperimentationRepositoriesProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return optimizelyFeatureExperimentationGenericAssetProjections(event)
}

func optimizelyFeatureExperimentationDeploymentsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return optimizelyFeatureExperimentationGenericDeploymentProjections(event)
}

func optimizelyFeatureExperimentationAuditEventsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return identityAuditProjections(event, identityProjectionProfile{Provider: "optimizely_feature_experimentation"})
}

func optimizelyFeatureExperimentationGenericAssetProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
...
func optimizelyFeatureExperimentationGenericDeploymentProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	tenantID, err := tenantID(event)
	if err != nil {
		return nil, nil, err
	}
