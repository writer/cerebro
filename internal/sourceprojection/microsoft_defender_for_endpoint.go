...
func microsoftDefenderForEndpointEndpointDevicesProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return microsoftDefenderForEndpointGenericAssetProjections(event)
}

func microsoftDefenderForEndpointFindingsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return microsoftDefenderForEndpointGenericFindingProjections(event)
}

func microsoftDefenderForEndpointVulnerabilitiesProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return microsoftDefenderForEndpointGenericFindingProjections(event)
}

func microsoftDefenderForEndpointGenericAssetProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
...
func microsoftDefenderForEndpointGenericFindingProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	tenantID, err := tenantID(event)
	if err != nil {
		return nil, nil, err
	}
