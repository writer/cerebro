...
func microsoftDefenderForCloudAppsAssetsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return microsoftDefenderForCloudAppsGenericAssetProjections(event)
}

func microsoftDefenderForCloudAppsFindingsProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return microsoftDefenderForCloudAppsGenericFindingProjections(event)
}

func microsoftDefenderForCloudAppsVulnerabilitiesProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	return microsoftDefenderForCloudAppsGenericFindingProjections(event)
}

func microsoftDefenderForCloudAppsGenericAssetProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
...
func microsoftDefenderForCloudAppsGenericFindingProjections(event *cerebrov1.EventEnvelope) ([]*ports.ProjectedEntity, []*ports.ProjectedLink, error) {
	tenantID, err := tenantID(event)
	if err != nil {
		return nil, nil, err
	}
