...
import "github.com/writer/cerebro/internal/attestedcompute"

// This table keeps static event-kind wiring separate from registry lifecycle,
// connector-definition overlays, dispatch, and tenant-scope validation.
...
var builtinRegistry = &Registry{projectors: map[string]ProjectFunc{
	...
	"grc.policy_rule":                               grcPolicyRuleProjections,
	"grc.evidence_requirement":                      grcEvidenceRequirementProjections,
	"grc.coverage_gap":                              grcCoverageGapProjections,
	...
	"duo_security.applications":                     duoApplicationProjections,
	"duo_security.audit_events":                     duoAuditEventProjections,
	"duo_security.groups":                           duoGroupProjections,
	"duo_security.roles":                            duoRoleProjections,
	"duo_security.users":                            duoUserProjections,
