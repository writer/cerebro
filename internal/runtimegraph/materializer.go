...
func observationMetadata(observation *runtime.RuntimeObservation, correlationKey string) map[string]any {
	...
	addMetadataString(metadata, "parent_span_id", metadataString(observation.Metadata, "parent_span_id"))
	addMetadataString(metadata, "span_kind", metadataString(observation.Metadata, "span_kind"))
	addMetadataString(metadata, "span_status_code", metadataString(observation.Metadata, "span_status_code"))
	addMetadataString(metadata, "service_name", serviceName(observation))
	addMetadataString(metadata, "service_namespace", metadataString(observation.Metadata, "service_namespace"))
	addMetadataString(metadata, "destination_service_name", metadataString(observation.Metadata, "destination_service_name"))
	addMetadataString(metadata, "destination_service_namespace", metadataString(observation.Metadata, "destination_service_namespace"))
	addMetadataString(metadata, "call_protocol", metadataString(observation.Metadata, "call_protocol"))
