...
var providerMetadata = map[string]ProviderMetadata{
	...
	"duo":              {Name: "duo", Maturity: ProviderMaturityBeta, Public: true},
	"cyberark":         {Name: "cyberark", Maturity: ProviderMaturityBeta, Public: true},
	...
	"forgerock":        {Name: "forgerock", Maturity: ProviderMaturityStub, Public: false},
	...
	"pingidentity":     {Name: "pingidentity", Maturity: ProviderMaturityBeta, Public: true},
	...
	"sailpoint":        {Name: "sailpoint", Maturity: ProviderMaturityBeta, Public: true},
	"saviynt":          {Name: "saviynt", Maturity: ProviderMaturityBeta, Public: true},
