...
func (e *EnsembleExecutor) ActionRequiresApproval(actionType ActionType) bool {
	switch actionType {
	case ActionPauseSubscription, ActionSendCustomerComm, ActionRestrictPublicStorageAccess, ActionDisableStaleAccessKey:
		return true
	default:
		return false
	}
...
func (e *EnsembleExecutor) ExecuteWithOutput(ctx context.Context, action Action, execution *Execution) (string, error) {
	...
	case ActionRestrictPublicStorageAccess, ActionDisableStaleAccessKey:
