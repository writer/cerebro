...
func fallbackRulepackAuditClassifications() []rulepackAuditClassification {
	return []rulepackAuditClassification{
		...
		{RuleID: "identity-okta-dormant-admin-role-assignment", Classification: "KEEP_AS_IS", BulkCloseoutThreshold: "none", Source: "okta"},
		{RuleID: "identity-okta-deprovisioned-active-cloud-access", Classification: "KEEP_AS_IS", BulkCloseoutThreshold: "none", Source: "okta"},
		{RuleID: "identity-okta-external-account-no-owner", Classification: "KEEP_AS_IS", BulkCloseoutThreshold: "none", Source: "okta"},
		{RuleID: "identity-okta-group-grants-admin-app", Classification: "KEEP_AS_IS", BulkCloseoutThreshold: "none", Source: "okta"},
		...
		{RuleID: "identity-okta-stale-app-assignment-30d", Classification: "KEEP_AS_IS", BulkCloseoutThreshold: "none", Source: "okta"},
		{RuleID: "identity-okta-stale-group-membership-90d", Classification: "KEEP_AS_IS", BulkCloseoutThreshold: "none", Source: "okta"},
		{RuleID: "identity-okta-suspended-user-active-assignment", Classification: "KEEP_AS_IS", BulkCloseoutThreshold: "none", Source: "okta"},
		{RuleID: "identity-okta-suspended-user-active-group-membership", Classification: "KEEP_AS_IS", BulkCloseoutThreshold: "none", Source: "okta"},
