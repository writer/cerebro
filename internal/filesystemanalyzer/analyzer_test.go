...
func TestAnalyzerDetectsExpandedCloudSecretFamiliesAndSkipsPlaceholders(t *testing.T) {
	root := t.TempDir()
	stripeKey := "sk_" + "live_" + "1234567890abcdefghijklmnop"
	sendGridKey := strings.Join([]string{"SG", "abcdefghijklmnop", "ABCDEFGHIJKLMNOP"}, ".")
	gcpAPIKey := "AIza" + "12345678901234567890123456789012345"
	googleOAuthClientSecret := "GOCSPX-" + "1234567890abcdefghijklmnop"
	twilioKey := "SK" + strings.Repeat("01234567", 4)
	jwtToken := strings.Join([]string{
		"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9",
		"eyJpc3MiOiJodHRwczovL2lzc3Vlci5leGFtcGxlLmNvbSIsInN1YiI6InN2Yy1hY2NvdW50IiwiZXhwIjoyMDAwMDAwMDAwfQ",
		"c2lnbmF0dXJl",
	}, ".")
