	...
	Controls: []Control{
		{
			...
			PolicyIDs:   []string{"gcp-iam-sa-admin-privileges", "gcp-sa-admin-privileges"},
		},
		{
			ID:          "1.4",
			...
			PolicyIDs:   []string{"gcp-service-account-keys", "gcp-iam-user-managed-keys"},
		},
		{
			ID:          "4.1",
			...
			PolicyIDs:   []string{"gcp-compute-default-sa", "gcp-gke-default-sa"},
		},
		{
			ID:          "5.1",
			...
			PolicyIDs:   []string{"gcp-storage-public", "gcp-storage-public-allusers"},
		},
		{
			ID:          "6.2.1",
			Title:       "Ensure Cloud SQL database instances require SSL",
			Description: "Cloud SQL instances should require SSL connections.",
			PolicyIDs:   []string{"gcp-sql-ssl-required", "gcp-cloudsql-public"},
		},
	},
}
...
var CISAzurev15 = Framework{
	...
	Controls: []Control{
		...
		},
		{
			...
			PolicyIDs:   []string{"azure-storage-https"},
		},
		{
			ID:          "3.7",
		...
		},
		{
			...
			PolicyIDs:   []string{"azure-sql-auditing"},
		},
		{
			ID:          "7.1",
